import{a as e}from"./chunk-BEqpzyXh.js";import{n as t,t as n}from"./jsx-runtime-BwJb0T-f.js";import{d as r,n as i,u as a}from"./chunk-QFMPRPBF-tanTk093.js";import{n as o}from"./api-C-kTb_mu.js";import{t as s}from"./AnimatedNumber-CbTovfmp.js";import{t as c}from"./esm-vWIRKc0d.js";var l=e(t(),1),u=n();function d(){return(0,u.jsxs)(`div`,{className:`gdsk`,children:[(0,u.jsxs)(`div`,{className:`gdsk-hero`,children:[(0,u.jsxs)(`div`,{className:`gdsk-side`,children:[(0,u.jsx)(`span`,{className:`kl-skel gdsk-logo`}),(0,u.jsx)(`span`,{className:`kl-skel gdsk-name`})]}),(0,u.jsx)(`span`,{className:`kl-skel gdsk-score`}),(0,u.jsxs)(`div`,{className:`gdsk-side gdsk-side-r`,children:[(0,u.jsx)(`span`,{className:`kl-skel gdsk-name`}),(0,u.jsx)(`span`,{className:`kl-skel gdsk-logo`})]})]}),(0,u.jsx)(`div`,{className:`gdsk-cols`,children:[0,1].map(e=>(0,u.jsx)(`div`,{className:`gdsk-col`,children:Array.from({length:10}).map((e,t)=>(0,u.jsx)(`span`,{className:`kl-skel gdsk-row`},t))},e))})]})}var f=[{hex:`#3a7dc4`,rgb:`58,125,196`},{hex:`#b87f3d`,rgb:`184,127,61`},{hex:`#8a6db8`,rgb:`138,109,184`},{hex:`#3d8c63`,rgb:`61,140,99`},{hex:`#c2932f`,rgb:`194,147,47`},{hex:`#b85a4a`,rgb:`184,90,74`},{hex:`#3d8a9c`,rgb:`61,138,156`},{hex:`#9d5878`,rgb:`157,88,120`}];function ee(e){return f[((e??0)%f.length+f.length)%f.length]}function te(e){let t=e.afl_games||[],n=t.filter(e=>e.status===`live`).length,r=t.filter(e=>e.status===`complete`).length,i=t.length;return e.gameday_state===`completed`?{tone:`done`,label:`FULL TIME`,sub:i?`${i}/${i} games`:`Round complete`}:e.gameday_state===`live`?{tone:`live`,label:n>0?`LIVE · ${n} ON`:`BETWEEN GAMES`,sub:`${r}/${i} games done`}:{tone:`upcoming`,label:`PRE-MATCH`,sub:e.first_bounce?`Bounce ${e.first_bounce}`:`Awaiting first bounce`}}var p=`
...
`;function m(){let{leagueId:e}=a(),[t]=r(),n=t.get(`fixture`),f=t.get(`round`),[m,ne]=(0,l.useState)(null),[re,ie]=(0,l.useState)(!0),[h,g]=(0,l.useState)(n?Number(n):null),[_,ae]=(0,l.useState)({}),[v,y]=(0,l.useState)(!1),[oe,b]=(0,l.useState)(!1),x=(0,l.useRef)({left:0,right:0}),S=(0,l.useCallback)(()=>{o(`/leagues/${e}/gameday?format=json${f?`&round=${f}`:``}`).then(e=>{ne(e),!h&&e.fixture&&g(e.fixture.id)}).catch(()=>{}).finally(()=>ie(!1))},[e,f]),se=(0,l.useCallback)(()=>{m&&o(`/leagues/${e}/gameday/api/fixtures?round=${m.afl_round}`).then(e=>{let t={};e.fixtures?.forEach(e=>{t[e.fixture_id]=e}),ae(t)}).catch(()=>{})},[e,m?.afl_round]);(0,l.useEffect)(()=>{S();let e=setInterval(S,6e4);return()=>clearInterval(e)},[S]),(0,l.useEffect)(()=>{n&&g(Number(n))},[n]),(0,l.useEffect)(()=>{m?.gameday_state},[m?.gameday_state]);let ce=(0,l.useRef)(null),le=(0,l.useRef)(0),C=m?.gameday_state===`live`&&!!m?.live_enabled,w=m?.afl_round;(0,l.useEffect)(()=>{if(!C)return;let t=c(`/matchups`,{withCredentials:!0,reconnection:!0,reconnectionAttempts:1/0,reconnectionDelay:2e3,reconnectionDelayMax:3e4});return ce.current=t,t.on(`connect`,()=>{t.emit(`join_live`,{league_id:Number(e),afl_round:w}),t.emit(`request_scores`,{league_id:Number(e),afl_round:w})}),t.on(`score_update`,e=>{e.seq&&e.seq<=le.current||(e.seq&&(le.current=e.seq),e.fixtures&&ae(t=>{let n={...t};return e.fixtures.forEach(e=>{n[e.fixture_id]=e}),n}))}),()=>{t.disconnect(),ce.current=null}},[e,C,w]);let T=(0,l.useRef)(!1);(0,l.useEffect)(()=>{m&&!T.current&&(T.current=!0,se())},[m,se]);let E=(0,l.useCallback)(e=>{g(e)},[]),ue=(0,l.useCallback)(async()=>{y(!0);try{await o(`/leagues/${e}/gameday/sync-scores`,{method:`POST`}).catch(()=>{}),S()}finally{setTimeout(()=>y(!1),1e3)}},[e,S]);if((0,l.useEffect)(()=>{if(m?.gameday_state!==`upcoming`)return;let t=setInterval(()=>{o(`/leagues/${e}/gameday/api/fixtures?round=${m.afl_round}`).then(e=>{}).catch(()=>{})},3e5);return()=>clearInterval(t)},[m?.gameday_state,m?.afl_round,e]),re)return(0,u.jsx)(d,{});if(!m)return(0,u.jsx)(`p`,{className:`text-danger`,children:`Failed to load gameday`});let D=new Set(m.teams_playing||[]);function O(e){let t=new Set([`field`,`reserve`]),n=e.filter(e=>t.has(e.lineup_type)&&(D.size===0||D.has(e.afl_team)));return{played:n.filter(e=>e.game_started&&((e.score||0)>0||e.is_dnp)).length,total:n.length}}function de(e){let t=!1,n=!1,r=!1,i=!1;return e.forEach(e=>{let a=e.game_started&&((e.score||0)>0||e.is_dnp);e.is_captain&&(t=!0,n=a),e.is_vice_captain&&(r=!0,i=a)}),{hasCap:t,capPlayed:n,hasVc:r,vcPlayed:i}}function k({players:e,rs:t}){let n=t&&t.has_captain!==void 0?{hasCap:!!t.has_captain,capPlayed:!!t.captain_played,hasVc:!!t.has_vc,vcPlayed:!!t.vc_played}:de(e);return(0,u.jsxs)(`span`,{style:{display:`inline-flex`,gap:4},children:[n.hasCap&&(0,u.jsx)(`span`,{className:`gd-role-badge${n.capPlayed?` active`:``}`,children:`C`}),n.hasVc&&(0,u.jsx)(`span`,{className:`gd-role-badge vc${n.vcPlayed?` active`:``}`,children:`VC`})]})}let A=m,j=A.gameday_state,M=!h||h===A.fixture?.id,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q=null,J=null,Y=null,X=null;if(M||!_[h])N=A.my_team?.name||``,P=A.opp_team?.name||``,F=A.my_score,I=A.opp_score,L=A.my_captain_bonus,R=A.opp_captain_bonus,z=A.my_players||[],B=A.opp_players||[],V=A.my_team?.logo_url,H=A.opp_team?.logo_url,G=A.my_team?.id,K=A.opp_team?.id,M&&A.projections&&(q=A.projections.my_projected,J=A.projections.opp_projected,Y=A.projections.my_win_pct,X=A.projections.opp_win_pct);else{let e=_[h],t=A.round_fixtures.find(e=>e.id===h);N=t?.home_team?.name||``,P=t?.away_team?.name||``,F=e.home_score||0,I=e.away_score||0,L=e.home_captain_bonus||0,R=e.away_captain_bonus||0,z=e.home_players||[],B=e.away_players||[],V=t?.home_team?.logo_url,H=t?.away_team?.logo_url,G=t?.home_team_id,K=t?.away_team_id,e.projections&&(q=e.projections.home_projected,J=e.projections.away_projected,Y=e.projections.home_win_pct,X=e.projections.away_win_pct)}G!=null&&(U=A.round_scores?.[String(G)]),K!=null&&(W=A.round_scores?.[String(K)]);let Z=Math.abs(Math.round(F-I));if(F!==x.current.left||I!==x.current.right){if((x.current.left!==0||x.current.right!==0)&&(setTimeout(()=>{b(!0),setTimeout(()=>b(!1),1500)},0),typeof navigator<`u`&&navigator.vibrate))try{navigator.vibrate(12)}catch{}x.current={left:F,right:I}}function Q(e){return[...e].sort((e,t)=>{let n=e.game_kickoff||`zzzz`,r=t.game_kickoff||`zzzz`;if(n!==r)return n<r?-1:1;let i=e.afl_team||``,a=t.afl_team||``;return i===a?(e.name||``).localeCompare(t.name||``):i.localeCompare(a)})}function $({p:e}){let t=!e.game_started&&j===`live`,n=e.subbed_on,r=e.is_emergency&&!n,i=[`gd-prow`,!!(e.player_id&&A.locked_player_ids?.includes(e.player_id))&&`locked`,e.is_dnp&&`dnp`,n&&`subbed-on`,e.lineup_type===`reserve`&&`reserve`,r&&`emg-standby`,t&&`ytp`].filter(Boolean).join(` `),a=[`gd-pscore`,e.is_dnp&&`dnp`,(e.lineup_type===`reserve`||r)&&`muted`,t&&`ytp`,e.is_live&&!t&&!r&&`live`].filter(Boolean).join(` `),o=(e.position||``).split(`/`)[0].toUpperCase();return(0,u.jsxs)(`div`,{className:i,children:[(0,u.jsx)(`span`,{className:`gd-pos ${o.toLowerCase()}`,children:o||`—`}),(0,u.jsxs)(`div`,{className:`gd-pbody`,children:[(0,u.jsxs)(`div`,{className:`gd-prow-name`,children:[e.is_captain&&(0,u.jsx)(`span`,{className:`gd-pbadge c`,children:`C`}),e.is_vice_captain&&(0,u.jsx)(`span`,{className:`gd-pbadge vc`,children:`VC`}),n&&(0,u.jsx)(`span`,{className:`gd-pbadge emg-active`,children:`EMG`}),e.is_dnp&&!n&&(0,u.jsx)(`span`,{className:`gd-pbadge dnp`,children:`DNP`}),r&&(0,u.jsx)(`span`,{className:`gd-pbadge emg`,children:`EMG`}),(0,u.jsx)(`span`,{className:`gd-pname`,children:e.name})]}),(0,u.jsxs)(`div`,{className:`gd-pfix`,children:[e.afl_team&&A.team_logos[e.afl_team]?(0,u.jsx)(`img`,{src:A.team_logos[e.afl_team],alt:e.afl_team,title:e.afl_team}):(0,u.jsx)(`span`,{children:e.afl_team}),A.afl_matchup_info[e.afl_team]&&(0,u.jsx)(`span`,{children:A.afl_matchup_info[e.afl_team]}),e.replaces&&(0,u.jsxs)(`span`,{className:`gd-sub-note`,children:[`→ for `,e.replaces]})]})]}),(0,u.jsx)(`span`,{className:a,children:e.lineup_type===`reserve`||r?`–`:t?(0,u.jsx)(u.Fragment,{children:(0,u.jsx)(`i`,{className:`bi bi-clock`,style:{fontSize:`.62rem`}})}):e.score||0})]})}function fe({players:e,teamName:t,score:n}){let r=e=>D.size===0||D.has(e.afl_team),i=e.filter(e=>e.lineup_type===`field`&&!e.is_dnp&&r(e)),a=e.filter(e=>e.lineup_type===`emergency`&&e.subbed_on&&r(e)),o=Q([...i,...a]),s=Q(e.filter(e=>e.lineup_type===`reserve`&&r(e))),c=Q(e.filter(e=>e.lineup_type===`emergency`&&!e.subbed_on&&r(e))),l=Q(e.filter(e=>e.is_dnp&&r(e))),d=Q(e.filter(e=>!r(e)));return(0,u.jsxs)(`div`,{className:`gd-pcard`,children:[(0,u.jsxs)(`div`,{className:`gd-pcard-header`,children:[(0,u.jsx)(`span`,{className:`gd-pcard-name`,children:t}),j!==`upcoming`&&(0,u.jsx)(`span`,{className:`gd-pcard-total`,children:Math.round(n)})]}),(0,u.jsxs)(`div`,{children:[(0,u.jsxs)(`div`,{className:`gd-section field`,children:[(0,u.jsx)(`i`,{className:`bi bi-broadcast`}),`Field · `,o.length]}),o.map((e,t)=>(0,u.jsx)($,{p:e},t)),s.length>0&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsxs)(`div`,{className:`gd-section bench`,children:[(0,u.jsx)(`i`,{className:`bi bi-arrow-left-right`}),`Bench · `,s.length]}),s.map((e,t)=>(0,u.jsx)($,{p:e},`b${t}`))]}),c.length>0&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsxs)(`div`,{className:`gd-section emergency`,children:[(0,u.jsx)(`i`,{className:`bi bi-shield-exclamation`}),`Emergency · `,c.length]}),c.map((e,t)=>(0,u.jsx)($,{p:e},`e${t}`))]}),l.length>0&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsxs)(`div`,{className:`gd-section dnp`,children:[(0,u.jsx)(`i`,{className:`bi bi-x-circle`}),`Did Not Play · `,l.length]}),l.map((e,t)=>(0,u.jsx)($,{p:e},`d${t}`))]}),d.length>0&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsxs)(`div`,{className:`gd-section nogame`,children:[(0,u.jsx)(`i`,{className:`bi bi-calendar-x`}),`No Game · `,d.length]}),d.map((e,t)=>(0,u.jsx)($,{p:e},`ng${t}`))]})]})]})}return(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`style`,{children:p}),(0,u.jsxs)(`div`,{className:`gd-comp-toggle`,children:[(0,u.jsx)(`span`,{className:`gd-comp-btn active`,children:`Main`}),(0,u.jsx)(i,{to:`/leagues/${e}/reserve7s/gameday`,className:`gd-comp-btn`,children:`7s`})]}),(0,u.jsxs)(`div`,{className:`gd-round-bar`,children:[(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`div`,{className:`gd-round-title`,children:A.afl_round===0?`PRE-SEASON`:`ROUND ${A.afl_round}`}),A.round_dates&&(0,u.jsx)(`div`,{className:`gd-round-dates`,children:A.round_dates})]}),(0,u.jsxs)(`div`,{className:`gd-round-state`,children:[(()=>{let e=te(A);return(0,u.jsxs)(`div`,{className:`gd-clock ${e.tone}`,children:[(0,u.jsx)(`span`,{className:`gd-clock-label`,children:e.label}),(0,u.jsx)(`span`,{className:`gd-clock-sub`,children:e.sub})]})})(),(0,u.jsx)(`button`,{className:`gd-refresh`,onClick:ue,disabled:v,title:`Sync scores`,children:v?(0,u.jsx)(`span`,{className:`spinner-border spinner-border-sm`,style:{width:12,height:12}}):(0,u.jsx)(`i`,{className:`bi bi-arrow-clockwise`})})]})]}),A.afl_games&&A.afl_games.length>0&&(()=>{let t=e=>e===`live`?0:e===`complete`?2:1;return(0,u.jsx)(`div`,{className:`gd-ticker d-none d-lg-flex`,children:[...A.afl_games].sort((e,n)=>t(e.status)-t(n.status)).map(t=>{let n=t.status===`live`?`live`:t.status===`complete`?`done`:`upcoming`,r=A.team_abbr[t.home_team]||t.home_team.substring(0,3).toUpperCase(),a=A.team_abbr[t.away_team]||t.away_team.substring(0,3).toUpperCase();return(0,u.jsxs)(i,{to:`/leagues/${e}/gameday/afl-game/${t.game_id}`,className:`gd-ticker-pill ${n}`,children:[(0,u.jsx)(`span`,{className:`gd-ticker-dot`}),(0,u.jsxs)(`span`,{className:`gd-ticker-teams`,children:[r,` v `,a]}),t.home_score!=null&&(0,u.jsxs)(`span`,{className:`gd-ticker-score`,children:[t.home_score,`-`,t.away_score]}),(0,u.jsx)(`span`,{className:`gd-ticker-tag`,children:t.status===`live`?`LIVE`:t.status===`complete`?`FT`:t.scheduled_display||(t.scheduled_start?t.scheduled_start.substring(11,16):`TBC`)})]},t.game_id)})})})(),A.round_fixtures&&A.round_fixtures.length>0&&(0,u.jsx)(`div`,{className:`gd-mini-bar`,children:A.round_fixtures.map(e=>{let t=_[e.id],n=t?.home_score??A.round_scores[String(e.home_team_id)]?.total_score??0,r=t?.away_score??A.round_scores[String(e.away_team_id)]?.total_score??0,i=!!(A.my_team&&(e.home_team_id===A.my_team.id||e.away_team_id===A.my_team.id)),a=h===e.id;return(0,u.jsxs)(`div`,{className:[`gd-mini-pill`,a&&`active`,i&&!a&&`yours`].filter(Boolean).join(` `),onClick:()=>E(e.id),children:[(0,u.jsxs)(`span`,{className:`gd-mini-teams`,children:[e.home_team?.name,` v `,e.away_team?.name]}),e.status!==`scheduled`&&(0,u.jsxs)(`span`,{className:`gd-mini-score`,children:[Math.round(n),`-`,Math.round(r)]})]},e.id)})}),A.is_bye?(0,u.jsxs)(`div`,{className:`gd-bye`,children:[(0,u.jsxs)(`h4`,{children:[(0,u.jsx)(`i`,{className:`bi bi-dash-circle me-2`}),`Bye this round`]}),(0,u.jsx)(`p`,{children:`Click any matchup above to view it.`})]}):(0,u.jsxs)(u.Fragment,{children:[(()=>{let t=ee(G),n=ee(K),r=F>I,a=I>F,o=j===`upcoming`,c=U?.players_total==null?O(z):{played:U.players_played??0,total:U.players_total},l=W?.players_total==null?O(B):{played:W.players_played??0,total:W.players_total},d={"--gd-side-accent":`rgba(${t.rgb},.6)`,"--gd-side-hex":t.hex,"--gd-side-rgb":t.rgb},f={"--gd-side-accent":`rgba(${n.rgb},.6)`,"--gd-side-hex":n.hex,"--gd-side-rgb":n.rgb},te={"--gd-left-accent":t.hex,"--gd-right-accent":n.hex},p=`gd-hero-score${o?` pre`:r?` leading`:``}${oe?` score-flash`:``}`,m=`gd-hero-score${o?` pre`:a?` leading`:``}${oe?` score-flash`:``}`;return(0,u.jsxs)(`div`,{className:`gd-hero`,children:[(0,u.jsxs)(`div`,{className:`gd-hero-band`,style:te,children:[(0,u.jsx)(`span`,{className:`gd-hero-band-l`}),(0,u.jsx)(`span`,{className:`gd-hero-band-r`})]}),(0,u.jsxs)(`div`,{className:`gd-hero-split`,children:[(0,u.jsxs)(`div`,{className:`gd-hero-side`,style:d,children:[M&&(0,u.jsx)(`span`,{className:`gd-hero-you`,children:`YOU`}),(0,u.jsxs)(`div`,{className:`gd-hero-top`,children:[(0,u.jsx)(`span`,{className:`gd-hero-crest`,children:V?(0,u.jsx)(`img`,{src:V,alt:``}):N.substring(0,2).toUpperCase()}),(0,u.jsx)(`span`,{className:`gd-hero-name`,children:N})]}),(0,u.jsx)(`div`,{className:`gd-hero-score-wrap`,children:(0,u.jsx)(s,{value:F,className:p})}),(0,u.jsxs)(`div`,{className:`gd-hero-meta`,children:[c.total>0&&(0,u.jsxs)(`span`,{className:`gd-hero-played`,children:[c.played,`/`,c.total,` played`]}),(0,u.jsx)(k,{players:z,rs:U}),L>0&&(0,u.jsxs)(`span`,{className:`gd-cap-bonus`,children:[`+`,Math.round(L),` C`]})]})]}),(0,u.jsxs)(`div`,{className:`gd-hero-side right`,style:f,children:[(0,u.jsxs)(`div`,{className:`gd-hero-top`,children:[(0,u.jsx)(`span`,{className:`gd-hero-crest`,children:H?(0,u.jsx)(`img`,{src:H,alt:``}):P.substring(0,2).toUpperCase()}),(0,u.jsx)(`span`,{className:`gd-hero-name`,children:P})]}),(0,u.jsx)(`div`,{className:`gd-hero-score-wrap`,children:(0,u.jsx)(s,{value:I,className:m})}),(0,u.jsxs)(`div`,{className:`gd-hero-meta`,children:[R>0&&(0,u.jsxs)(`span`,{className:`gd-cap-bonus`,children:[`+`,Math.round(R),` C`]}),(0,u.jsx)(k,{players:B,rs:W}),l.total>0&&(0,u.jsxs)(`span`,{className:`gd-hero-played`,children:[l.played,`/`,l.total,` played`]})]})]})]}),(0,u.jsx)(`div`,{className:`gd-hero-strip`,children:j===`upcoming`?(0,u.jsxs)(u.Fragment,{children:[A.first_bounce&&(0,u.jsxs)(`span`,{className:`gd-first-bounce`,children:[(0,u.jsx)(`i`,{className:`bi bi-clock-fill`}),`First bounce `,A.first_bounce]}),q!=null&&J!=null&&(0,u.jsxs)(`div`,{className:`gd-proj-row`,children:[(0,u.jsxs)(`span`,{className:`gd-proj-item`,children:[`Proj `,(0,u.jsx)(`b`,{children:Math.round(q)}),`–`,(0,u.jsx)(`b`,{children:Math.round(J)})]}),(0,u.jsx)(`span`,{className:`gd-proj-sep`}),(0,u.jsxs)(`span`,{className:`gd-proj-item`,children:[`Win `,(0,u.jsxs)(`b`,{children:[Math.round(Y||0),`%`]}),`–`,(0,u.jsxs)(`b`,{children:[Math.round(X||0),`%`]})]})]})]}):j===`completed`?(0,u.jsxs)(u.Fragment,{children:[(r||a)&&(0,u.jsx)(`div`,{className:`gd-margin-chip${M&&r?` win`:M&&a?` loss`:``}`,children:M?r?(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`i`,{className:`bi bi-trophy-fill`}),`WON BY `,Z]}):(0,u.jsxs)(u.Fragment,{children:[`LOST BY `,Z]}):r?(0,u.jsxs)(u.Fragment,{children:[N,` BY `,Z]}):(0,u.jsxs)(u.Fragment,{children:[P,` BY `,Z]})}),!r&&!a&&(0,u.jsx)(`div`,{className:`gd-margin-chip`,children:`DRAW`}),A.fixture&&(0,u.jsxs)(i,{to:`/leagues/${e}/matchup/${A.fixture.id}`,className:`gd-breakdown-link`,children:[(0,u.jsx)(`i`,{className:`bi bi-bar-chart-line`}),`Full Breakdown`]})]}):(0,u.jsxs)(u.Fragment,{children:[(r||a)&&(0,u.jsx)(`div`,{className:`gd-margin-chip${M&&r?` up`:M&&a?` down`:``}`,children:M?r?(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`i`,{className:`bi bi-caret-up-fill`}),`UP `,Z]}):(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`i`,{className:`bi bi-caret-down-fill`}),`DOWN `,Z]}):r?(0,u.jsxs)(u.Fragment,{children:[N,` BY `,Z]}):(0,u.jsxs)(u.Fragment,{children:[P,` BY `,Z]})}),q!=null&&J!=null&&(0,u.jsxs)(`div`,{className:`gd-proj-row`,children:[(0,u.jsxs)(`span`,{className:`gd-proj-item`,children:[`Proj `,(0,u.jsx)(`b`,{children:Math.round(q)}),`–`,(0,u.jsx)(`b`,{children:Math.round(J)})]}),(0,u.jsx)(`span`,{className:`gd-proj-sep`}),(0,u.jsxs)(`span`,{className:`gd-proj-item`,children:[`Win `,(0,u.jsxs)(`b`,{children:[Math.round(Y||0),`%`]}),`–`,(0,u.jsxs)(`b`,{children:[Math.round(X||0),`%`]})]})]})]})})]})})(),(0,u.jsxs)(`div`,{className:`d-lg-none mt-3 gd-mob-vs`,children:[(0,u.jsxs)(`div`,{className:`gd-mob-vs-header`,children:[(0,u.jsx)(`span`,{className:`gd-mob-vs-team`,children:N}),(0,u.jsxs)(`span`,{className:`gd-mob-vs-scores`,children:[(0,u.jsx)(`span`,{className:`gd-mob-vs-sc${F>I?` gd-mob-sc-win`:``}`,children:Math.round(F)}),(0,u.jsx)(`span`,{style:{color:`#484f58`,fontSize:`.7rem`},children:`v`}),(0,u.jsx)(`span`,{className:`gd-mob-vs-sc${I>F?` gd-mob-sc-win`:``}`,children:Math.round(I)})]}),(0,u.jsx)(`span`,{className:`gd-mob-vs-team`,style:{textAlign:`right`},children:P})]}),(0,u.jsxs)(`div`,{className:`gd-mob-section-hdr`,children:[(0,u.jsx)(`i`,{className:`bi bi-people-fill me-1`}),`Field`]}),(()=>{let e=e=>Q([...e.filter(e=>e.lineup_type===`field`&&!e.is_dnp),...e.filter(e=>e.lineup_type===`emergency`&&e.subbed_on)]),t=e(z),n=e(B),r=Math.max(t.length,n.length);return Array.from({length:r}).map((e,r)=>{let i=t[r],a=n[r];return(0,u.jsxs)(`div`,{className:`gd-mob-vs-row`,children:[(0,u.jsx)(`div`,{className:`gd-mob-vs-left`,children:i&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsxs)(`span`,{className:`gd-mob-vs-name`,children:[i.is_captain&&(0,u.jsx)(`b`,{className:`gd-mob-c`,children:`C`}),i.is_vice_captain&&(0,u.jsx)(`b`,{className:`gd-mob-vc`,children:`VC`}),i.subbed_on&&(0,u.jsx)(`span`,{className:`gameday-badge-emg-active`,style:{fontSize:`.5rem`,padding:`0 3px`},children:`EMG`}),i.name]}),(0,u.jsx)(`span`,{className:`gd-mob-vs-pos pos-badge pos-${(i.position||`MID`).split(`/`)[0].toUpperCase()}`,children:(i.position||`MID`).split(`/`)[0].substring(0,3).toUpperCase()})]})}),(0,u.jsxs)(`div`,{className:`gd-mob-vs-mid`,children:[(0,u.jsxs)(`span`,{className:`gd-mob-sc-l${i?.is_live?` text-success`:``}`,children:[i?i.score||0:`-`,i?.is_live&&(0,u.jsx)(`i`,{className:`bi bi-circle-fill gameday-live-dot`})]}),(0,u.jsxs)(`span`,{className:`gd-mob-sc-r${a?.is_live?` text-success`:``}`,children:[a?a.score||0:`-`,a?.is_live&&(0,u.jsx)(`i`,{className:`bi bi-circle-fill gameday-live-dot`})]})]}),(0,u.jsx)(`div`,{className:`gd-mob-vs-right`,children:a&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`span`,{className:`gd-mob-vs-pos pos-badge pos-${(a.position||`MID`).split(`/`)[0].toUpperCase()}`,children:(a.position||`MID`).split(`/`)[0].substring(0,3).toUpperCase()}),(0,u.jsxs)(`span`,{className:`gd-mob-vs-name`,children:[a.is_captain&&(0,u.jsx)(`b`,{className:`gd-mob-c`,children:`C`}),a.is_vice_captain&&(0,u.jsx)(`b`,{className:`gd-mob-vc`,children:`VC`}),a.subbed_on&&(0,u.jsx)(`span`,{className:`gameday-badge-emg-active`,style:{fontSize:`.5rem`,padding:`0 3px`},children:`EMG`}),a.name]})]})})]},r)})})()]}),(0,u.jsxs)(`div`,{className:`row g-3 mt-2 d-none d-lg-flex`,children:[(0,u.jsx)(`div`,{className:`col-md-6`,children:(0,u.jsx)(fe,{players:z,teamName:N,score:F})}),(0,u.jsx)(`div`,{className:`col-md-6`,children:(0,u.jsx)(fe,{players:B,teamName:P,score:I})})]})]}),(0,u.jsxs)(`div`,{className:`gd-foot`,children:[(0,u.jsx)(`span`,{children:j===`live`?(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`i`,{className:`bi bi-broadcast me-1`,style:{color:`#7dc99a`}}),`Live · WebSocket sync`]}):j===`completed`?`Final results`:(0,u.jsx)(u.Fragment,{children:`\xA0`})}),(0,u.jsx)(i,{to:`/leagues/${e}/fixture`,children:`Season Fixture →`})]}),(0,u.jsxs)(`div`,{className:`gameday-all-matchups mt-4`,style:{display:`none`},children:[(0,u.jsxs)(`div`,{className:`gameday-matchups-header`,children:[(0,u.jsxs)(`span`,{children:[(0,u.jsx)(`i`,{className:`bi bi-grid-3x2-gap me-2`}),`ROUND `,A.afl_round,` MATCHUPS`]}),A.round_dates&&(0,u.jsx)(`span`,{className:`matchups-header-dates`,children:A.round_dates})]}),(0,u.jsx)(`div`,{className:`gameday-matchups-grid`,children:(A.round_fixtures||[]).map(e=>{let t=A.round_scores[String(e.home_team_id)]?.total_score||e.home_score||0,n=A.round_scores[String(e.away_team_id)]?.total_score||e.away_score||0,r=A.my_team&&(e.home_team_id===A.my_team.id||e.away_team_id===A.my_team.id),i=t>n&&e.status!==`scheduled`,a=n>t&&e.status!==`scheduled`,o=t+n||1;return(0,u.jsxs)(`div`,{className:`gameday-matchup-card${r?` matchup-yours`:``}${h===e.id?` matchup-active`:``}${r&&h!==e.id?` matchup-yours-dimmed`:``}`,onClick:()=>E(e.id),style:{cursor:`pointer`},children:[r&&(0,u.jsx)(`span`,{className:`matchup-your-tag`,children:`Your Match`}),(0,u.jsxs)(`div`,{className:`matchup-team-row`,children:[(0,u.jsx)(`span`,{className:`matchup-team-name${i?` matchup-winner`:``}`,children:e.home_team?.name}),(0,u.jsxs)(`span`,{className:`matchup-team-score`,children:[e.status!==`scheduled`&&Math.round(t),i&&(0,u.jsx)(`i`,{className:`bi bi-check-lg`,style:{color:`var(--kl-accent-green)`,fontSize:`.7rem`}})]})]}),(0,u.jsxs)(`div`,{className:`matchup-team-row`,children:[(0,u.jsx)(`span`,{className:`matchup-team-name${a?` matchup-winner`:``}`,children:e.away_team?.name}),(0,u.jsxs)(`span`,{className:`matchup-team-score`,children:[e.status!==`scheduled`&&Math.round(n),a&&(0,u.jsx)(`i`,{className:`bi bi-check-lg`,style:{color:`var(--kl-accent-green)`,fontSize:`.7rem`}})]})]}),e.status!==`scheduled`&&(0,u.jsx)(`div`,{className:`matchup-mini-bar`,children:(0,u.jsx)(`div`,{className:`matchup-mini-fill`,style:{width:`${t/o*100}%`}})}),_[e.id]&&(0,u.jsxs)(`div`,{className:`d-flex justify-content-between align-items-center`,style:{marginTop:6},children:[(()=>{let t=O(_[e.id].home_players||[]);return t.total>0?(0,u.jsxs)(`span`,{className:`matchup-players-count`,style:{fontSize:`.6rem`,color:`var(--kl-text-faint)`},children:[t.played,`/`,t.total]}):(0,u.jsx)(`span`,{})})(),(0,u.jsxs)(`div`,{className:`d-flex gap-1`,children:[(0,u.jsx)(k,{players:_[e.id].home_players||[]}),(0,u.jsx)(k,{players:_[e.id].away_players||[]})]}),(()=>{let t=O(_[e.id].away_players||[]);return t.total>0?(0,u.jsxs)(`span`,{className:`matchup-players-count`,style:{fontSize:`.6rem`,color:`var(--kl-text-faint)`},children:[t.played,`/`,t.total]}):(0,u.jsx)(`span`,{})})()]}),e.status!==`scheduled`&&t!==n&&(0,u.jsxs)(`div`,{className:`matchup-margin`,children:[i?e.home_team?.name:e.away_team?.name,` +`,Math.round(Math.abs(t-n))]})]},e.id)})})]})]})}export{m as GamedayPage};