import{b as e,d as t,f as n,h as r,i,n as a,t as ee}from"./Spinner-BZqcd_eb.js";import{n as te}from"./api-BFFY-yxh.js";import{t as ne}from"./useSocket-Bgvorr-7.js";var o=e(r(),1),s=a(),c=[{key:`sc_average`,label:`SC Avg`},{key:`age_factor`,label:`Longevity`},{key:`positional_scarcity`,label:`Scarcity`},{key:`trajectory`,label:`Trajectory`},{key:`durability`,label:`Durability`},{key:`rating_potential`,label:`Growth`}],re=[`#82b3e4`,`#7dc99a`,`#c2932f`,`#e07a6c`,`#b39ed4`,`#7ec0d3`,`#d68a7e`,`#f0d27a`],ie=`
/* === Draft room · Stadium ====================================== */
...
`;function ae(e){if(e<=0)return`Starting soon...`;let t=Math.floor(e/1e3),n=Math.floor(t/86400),r=Math.floor(t%86400/3600),i=Math.floor(t%3600/60),a=t%60;return n>0?`${n}d ${r}h ${i}m`:r>0?`${r}h ${i}m ${a}s`:i>0?`${i}m ${a}s`:`${a}s`}function l(e){return e?e.split(`/`)[0].toLowerCase():`mid`}function oe(e){return e==null?`tier-empty`:e>=80?`tier-elite`:e>=70?`tier-good`:e>=60?`tier-ok`:`tier-low`}function se(e){return e==null?`tier-empty`:e>=80?`tier-elite`:e>=70?`tier-good`:e>=60?`tier-ok`:`tier-low`}function u(){let{leagueId:e}=n(),r=t(),[a,u]=(0,o.useState)(null),[ce,d]=(0,o.useState)(!0),[f,p]=(0,o.useState)(null),[m,h]=(0,o.useState)([]),[g,le]=(0,o.useState)(null),[ue,de]=(0,o.useState)([]),[_,fe]=(0,o.useState)(``),[v,pe]=(0,o.useState)(``),[y,me]=(0,o.useState)(``),[b,he]=(0,o.useState)(``),[x,ge]=(0,o.useState)(`draft_score`),[S,C]=(0,o.useState)(`desc`),[w,T]=(0,o.useState)({}),[_e,ve]=(0,o.useState)(!1),[ye,be]=(0,o.useState)(!1),[E,D]=(0,o.useState)(`all`),[O,k]=(0,o.useState)(null),[xe,A]=(0,o.useState)(!1),[Se,j]=(0,o.useState)(!1),[M,Ce]=(0,o.useState)(!1),[N,we]=(0,o.useState)(()=>typeof window<`u`&&window.innerWidth>=992),[P,F]=(0,o.useState)([]),[I,L]=(0,o.useState)(``),[R,Te]=(0,o.useState)(0),z=(0,o.useRef)(null),B=(0,o.useRef)({}),[Ee,V]=(0,o.useState)(``),[De,Oe]=(0,o.useState)(``),H=(0,o.useRef)(null);(0,o.useEffect)(()=>{d(!0),te(`/leagues/${e}/draft?format=json`).then(e=>{u(e),p(e.state),T(e.user_weights),be(e.has_custom_weights),e.session.scheduled_start&&V(e.session.scheduled_start.slice(0,16))}).catch(()=>{}).finally(()=>d(!1))},[e]),(0,o.useEffect)(()=>{H.current&&window.clearInterval(H.current);let e=a?.session.scheduled_start;if(!e||f?.status!==`scheduled`){Oe(e?``:`No time set`);return}let t=()=>{Oe(ae(new Date(e).getTime()-Date.now()))};return t(),H.current=window.setInterval(t,1e3),()=>{H.current&&window.clearInterval(H.current)}},[a?.session.scheduled_start,f?.status]);let U=(0,o.useCallback)(()=>{a?.user_team&&fetch(`/leagues/${e}/draft/api/position_needs`,{credentials:`same-origin`}).then(e=>e.json()).then(e=>{e.error||le(e)}).catch(()=>{})},[e,a?.user_team]),W=(0,o.useCallback)(()=>{a?.user_team&&fetch(`/leagues/${e}/draft/api/team_picks/${a.user_team.id}`,{credentials:`same-origin`}).then(e=>e.json()).then(de).catch(()=>{})},[e,a?.user_team]),G=(0,o.useCallback)(()=>{let t=c.map(e=>`w_${e.key}=${w[e.key]??.2}`).join(`&`),n=b?800:200,r=new URLSearchParams;r.set(`q`,_),v&&r.set(`pos`,v),r.set(`limit`,String(n)),fetch(`/leagues/${e}/draft/api/available?${r.toString()}&${t}`,{credentials:`same-origin`}).then(e=>e.json()).then(e=>h(e)).catch(()=>h([]))},[e,_,v,b,w]);(0,o.useEffect)(()=>{a&&G()},[a,G]),(0,o.useEffect)(()=>{a&&(U(),W())},[a,U,W]),(0,o.useEffect)(()=>{a&&fetch(`/leagues/${e}/draft/api/chat_history`,{credentials:`same-origin`}).then(e=>e.json()).then(e=>F(e)).catch(()=>{})},[e,a]),(0,o.useEffect)(()=>{z.current&&(z.current.scrollTop=z.current.scrollHeight)},[P,N]);let{socket:K,state:ke}=ne({namespace:`/draft`,onConnect:t=>t.emit(`join_draft`,{league_id:Number(e)}),events:{draft_state:e=>{p(e),U(),W(),G()},pick_made:e=>{let t=e;p(e=>e&&{...e,pick_history:[t,...e.pick_history],picks_made:e.picks_made+1,picked_player_ids:t.player_id?[...e.picked_player_ids,t.player_id]:e.picked_player_ids}),F(e=>[...e,{team_name:t.team_name,message:t.is_pass?`${t.team_name} passed`:`${t.team_name} drafted ${t.player_name}`,is_system:!0}]),U(),G(),t.team_id===a?.user_team?.id&&W()},timer_tick:e=>{let{remaining:t}=e;p(e=>e&&{...e,timer_remaining:t})},draft_completed:e=>{p({...e,status:`completed`})},draft_chat_msg:e=>{let t=e;F(e=>[...e,t]),N||Te(e=>e+1)},schedule_updated:e=>{let{scheduled_start:t}=e;u(e=>e&&{...e,session:{...e.session,scheduled_start:t}}),t&&V(t.slice(0,16))},error:e=>alert(e.message)}}),Ae=(0,o.useMemo)(()=>{let e=m.filter(e=>!(f&&e.id!=null&&f.picked_player_ids.includes(e.id)));y&&(e=e.filter(e=>e.age==null?!1:y===`30+`?e.age>=30:y===`25-30`?e.age>=25&&e.age<=30:e.age<parseInt(y))),b&&(e=e.filter(e=>e.afl_team===b));let t=S===`asc`?1:-1;return e.slice().sort((e,n)=>{let r=e[x],i=n[x];return r==null&&i==null?0:r==null?1:i==null?-1:typeof r==`string`&&typeof i==`string`?t*r.localeCompare(i):t*(r-i)}).slice(0,100)},[m,y,b,x,S,f]),je=(0,o.useMemo)(()=>{let e=new Set;return m.forEach(t=>{t.afl_team&&e.add(t.afl_team)}),[...e].sort()},[m]),Me=e=>{x===e?C(e=>e===`desc`?`asc`:`desc`):(ge(e),C([`name`,`position`,`afl_team`].includes(e)?`asc`:`desc`))},Ne=e=>x===e?S===`desc`?`bi-chevron-down`:`bi-chevron-up`:`bi-chevron-expand`,Pe=!!(a?.user_team&&f?.current_team_id===a.user_team.id),Fe=f?.status===`in_progress`&&(Pe||a?.is_commissioner&&M);function Ie(e){return!g||!g.blocked_positions.length||!e?!1:e.split(`/`).map(e=>e.trim().toUpperCase()).every(e=>g.blocked_positions.includes(e))}function Le(e){if(!K?.connected){alert(`Not connected — refresh the page.`);return}k(e)}function Re(){O==null||!K||(K.emit(`make_pick`,{league_id:Number(e),player_id:O}),k(null))}function ze(){K?.emit(`pass_pick`,{league_id:Number(e)}),A(!1)}function Be(e){if(!B.current[e]){let t=Object.keys(B.current).length;B.current[e]=re[t%re.length]}return B.current[e]}function Ve(){!I.trim()||!K||(K.emit(`draft_chat`,{league_id:Number(e),message:I.trim()}),L(``))}function He(){let e=!N;we(e),e&&Te(0)}function Ue(e,t){T(n=>({...n,[e]:t}))}function We(){G()}async function Ge(){try{let t=await(await fetch(`/leagues/${e}/draft/api/save_weights`,{method:`POST`,credentials:`same-origin`,headers:{"Content-Type":`application/json`},body:JSON.stringify(w)})).json();t.status===`ok`&&(t.weights&&T(t.weights),be(!0),G())}catch{}}function Ke(){K?.emit(`update_schedule`,{league_id:Number(e),scheduled_start:Ee||null})}function qe(){K?.emit(`start_draft`,{league_id:Number(e)})}function Je(){confirm(`Pause the draft? All timers will stop.`)&&K?.emit(`pause_draft`,{league_id:Number(e)})}function Ye(){K?.emit(`resume_draft`,{league_id:Number(e)})}function Xe(){confirm(`Undo the last pick?`)&&K?.emit(`undo_pick`,{league_id:Number(e)})}function Ze(){if(!confirm(`Are you sure you want to restart the draft?
