import{b as e,f as t,h as n,i as r,n as i,p as a,t as o}from"./Spinner-BZqcd_eb.js";import{t as s}from"./useFetch-DvbxBrvD.js";import{t as c}from"./LeagueSubnav-B057D_-7.js";var l=e(n(),1),u=i(),d=`
...
`;function f(e){let t=e.toLowerCase();return t.includes(`supercoach`)?`sc`:t.includes(`fantasy`)?`af`:t.includes(`ultimate`)?`uf`:t.includes(`hybrid`)?`hybrid`:`custom`}function p({mode:e=`main`}={}){let{leagueId:n}=t(),[i]=a(),p=i.get(`round`),m=e===`sevens`,h=m?`/leagues/${n}/reserve7s/fixture`:`/leagues/${n}/fixture`,g=m?`/leagues/${n}/reserve7s/gameday`:`/leagues/${n}/gameday`,_=e=>m?`/leagues/${n}/reserve7s/matchup/${e}`:`/leagues/${n}/matchup/${e}`,{data:v,loading:y}=s(m?`/leagues/${n}/reserve7s/fixture?format=json${p?`&round=${p}`:``}`:`/leagues/${n}/fixture?format=json${p?`&round=${p}`:``}`),b=(0,l.useRef)(null);if((0,l.useEffect)(()=>{if(b.current){let e=b.current.querySelector(`.rnd-item.active`);if(e){let t=e.offsetLeft-b.current.offsetWidth/2+e.offsetWidth/2;b.current.scrollLeft=Math.max(0,t)}}},[v?.selected_round]),y)return(0,u.jsx)(o,{text:`Loading fixture...`});if(!v)return(0,u.jsx)(`p`,{className:`text-danger`,children:`Failed to load fixture`});let{round_meta:x,selected_round:S,current_fixtures:C,scoring:w,is_commissioner:T}=v,E=Object.keys(x).map(Number).sort((e,t)=>e-t),D=x[String(S)]||`scheduled`,O=f(w.label),k=E.length>0,A=m?`#bc8cff`:`#58a6ff`,j=m?`rgba(188,140,255,.08)`:`rgba(88,166,255,.08)`,M=m?`rgba(188,140,255,.3)`:`rgba(88,166,255,.3)`;return(0,u.jsxs)(`div`,{className:m?`fx-sevens`:``,children:[(0,u.jsx)(`style`,{children:d}),m&&(0,u.jsx)(`style`,{children:`
