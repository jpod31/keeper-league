import{d as e,f as t,m as n,r,t as i,y as a}from"./jsx-runtime-mCRDCYrZ.js";import{t as o}from"./Spinner-EE11lljr.js";import{t as s}from"./useFetch-CaeYCXfu.js";import{t as c}from"./LeagueSubnav-BHwwXzSQ.js";var l=a(n(),1),u=i(),d=`
...
`;function f(){let{leagueId:n}=e(),[i]=t(),a=i.get(`round`),{data:f,loading:p}=s(`/leagues/${n}/reserve7s/fixture?format=json${a?`&round=${a}`:``}`),m=(0,l.useRef)(null);if((0,l.useEffect)(()=>{if(m.current){let e=m.current.querySelector(`.s7f-item.active`);if(e){let t=e.offsetLeft-m.current.offsetWidth/2+e.offsetWidth/2;m.current.scrollLeft=Math.max(0,t)}}},[f?.selected_round]),p)return(0,u.jsx)(o,{text:`Loading 7s fixture...`});if(!f)return(0,u.jsx)(`p`,{className:`text-danger`,children:`Failed to load 7s fixture`});let{round_meta:h,selected_round:g,current_fixtures:_,scoring:v}=f,y=Object.keys(h).map(Number).sort((e,t)=>e-t),b=h[String(g)]||`scheduled`,x=y.length>0;return(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`style`,{children:d}),(0,u.jsx)(c,{active:`7s`,leagueId:n}),(0,u.jsxs)(`div`,{className:`s7-subnav`,children:[(0,u.jsx)(r,{to:`/leagues/${n}/reserve7s/standings`,className:`s7-subnav-tab`,children:`Ladder`}),(0,u.jsx)(r,{to:`/leagues/${n}/reserve7s/fixture`,className:`s7-subnav-tab active`,children:`Fixture`}),(0,u.jsx)(r,{to:`/leagues/${n}/reserve7s/gameday`,className:`s7-subnav-tab`,children:`Gameday`}),(0,u.jsx)(r,{to:`/leagues/${n}/reserve7s/team`,className:`s7-subnav-tab`,children:`My 7s`})]}),(0,u.jsxs)(`div`,{className:`s7f-title`,children:[(0,u.jsxs)(`h3`,{children:[(0,u.jsx)(`i`,{className:`bi bi-7-circle me-1`,style:{color:`#bc8cff`}}),`Reserve 7s Season`]}),(0,u.jsx)(`span`,{className:`s7f-title-badge`,children:`RESERVE 7s`})]}),x?(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`div`,{className:`s7f-strip`,ref:m,children:y.map(e=>{let t=h[String(e)],i=t===`completed`?`s7f-dot-done`:t===`live`?`s7f-dot-live`:`s7f-dot-none`,a=t===`completed`?` s7f-done`:t===`live`?` s7f-live`:``;return(0,u.jsxs)(r,{to:`/leagues/${n}/reserve7s/fixture?round=${e}`,className:`s7f-item${e===g?` active`:``}${a}`,children:[(0,u.jsx)(`span`,{className:`s7f-num`,children:e}),(0,u.jsx)(`span`,{className:`s7f-dot ${i}`})]},e)})}),(0,u.jsx)(`div`,{className:`s7f-round-hdr`,children:(0,u.jsxs)(`div`,{style:{display:`flex`,alignItems:`baseline`,gap:10},children:[(0,u.jsxs)(`h3`,{children:[`Round `,g]}),b===`completed`&&(0,u.jsx)(`span`,{className:`s7f-rh-badge s7f-rh-complete`,children:`Complete`}),b===`live`&&(0,u.jsxs)(`span`,{className:`s7f-rh-badge s7f-rh-live`,children:[(0,u.jsx)(`i`,{className:`bi bi-broadcast me-1`}),`Live`]}),(0,u.jsx)(`span`,{className:`s7f-title-badge`,children:v.label})]})}),(0,u.jsx)(`div`,{className:`s7f-list`,children:_.map(e=>{let t=e.status===`completed`&&(e.home_score||0)>(e.away_score||0),n=e.status===`completed`&&(e.away_score||0)>(e.home_score||0);return(0,u.jsxs)(`div`,{className:`s7f-row`,children:[(0,u.jsx)(`span`,{className:`s7f-team s7f-team-home${t?` won`:``}`,children:e.home_team?.name}),(0,u.jsx)(`div`,{className:`s7f-centre`,children:e.status===`completed`?(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`span`,{className:`s7f-sc${t?` won`:` lost`}`,children:Math.round(e.home_score||0)}),(0,u.jsx)(`span`,{className:`s7f-sep`,children:`–`}),(0,u.jsx)(`span`,{className:`s7f-sc${n?` won`:` lost`}`,children:Math.round(e.away_score||0)})]}):(0,u.jsx)(`span`,{className:`s7f-vs`,children:`vs`})}),(0,u.jsx)(`span`,{className:`s7f-team s7f-team-away${n?` won`:``}`,children:e.away_team?.name})]},e.id)})})]}):(0,u.jsxs)(`div`,{className:`s7f-empty`,children:[(0,u.jsx)(`i`,{className:`bi bi-calendar-week`}),(0,u.jsx)(`h4`,{children:`No Reserve 7s fixture yet`}),(0,u.jsx)(`p`,{style:{fontSize:`.8rem`},children:`The 7s fixture auto-generates when the main season fixture is created.`})]})]})}export{f as Reserve7sFixturePage};