import{f as e,h as t,i as n,n as r,p as i,t as a,v as o}from"./Spinner-DbpdyvTu.js";import{t as s}from"./useFetch-7HaRuJqe.js";var c=o(t(),1),l=r(),u=`
...
`;function d(){let{leagueId:t}=e(),[r]=i(),o=r.get(`round`),{data:d,loading:f,refetch:p}=s(`/leagues/${t}/reserve7s/fixture?format=json${o?`&round=${o}`:``}`),m=(0,c.useRef)(null),[h,g]=(0,c.useState)(!1);async function _(){g(!0);try{await fetch(`/leagues/${t}/reserve7s/generate-fixture`,{method:`POST`,credentials:`include`,redirect:`manual`}),p()}catch(e){alert(e.message)}finally{g(!1)}}if((0,c.useEffect)(()=>{if(m.current){let e=m.current.querySelector(`.s7f-item.active`);if(e){let t=e.offsetLeft-m.current.offsetWidth/2+e.offsetWidth/2;m.current.scrollLeft=Math.max(0,t)}}},[d?.selected_round]),f)return(0,l.jsx)(a,{text:`Loading 7s fixture...`});if(!d)return(0,l.jsx)(`p`,{className:`text-danger`,children:`Failed to load 7s fixture`});let{round_meta:v,selected_round:y,current_fixtures:b,scoring:x,is_commissioner:S}=d,C=Object.keys(v).map(Number).sort((e,t)=>e-t),w=v[String(y)]||`scheduled`,T=C.length>0;return(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`style`,{children:u}),(0,l.jsxs)(`div`,{className:`s7-subnav`,children:[(0,l.jsx)(n,{to:`/leagues/${t}/reserve7s/standings`,className:`s7-subnav-tab`,children:`Ladder`}),(0,l.jsx)(n,{to:`/leagues/${t}/reserve7s/fixture`,className:`s7-subnav-tab active`,children:`Fixture`}),(0,l.jsx)(n,{to:`/leagues/${t}/reserve7s/gameday`,className:`s7-subnav-tab`,children:`Gameday`}),(0,l.jsx)(n,{to:`/leagues/${t}/reserve7s/team`,className:`s7-subnav-tab`,children:`My 7s`})]}),(0,l.jsxs)(`div`,{className:`comp-toggle`,children:[(0,l.jsx)(n,{to:`/leagues/${t}/fixture`,className:`comp-toggle-btn text-decoration-none`,style:{borderColor:`#30363d`,color:`#8b949e`,borderRadius:`8px 0 0 8px`},children:`Main`}),(0,l.jsx)(`span`,{className:`comp-toggle-btn`,style:{borderColor:`rgba(188,140,255,.3)`,color:`#bc8cff`,background:`rgba(188,140,255,.08)`,borderRadius:`0 8px 8px 0`,borderLeft:0},children:`7s`})]}),T?(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(`div`,{className:`s7f-strip`,ref:m,children:C.map(e=>{let r=v[String(e)],i=r===`completed`?`s7f-dot-done`:r===`live`?`s7f-dot-live`:`s7f-dot-none`,a=r===`completed`?` s7f-done`:r===`live`?` s7f-live`:``;return(0,l.jsxs)(n,{to:`/leagues/${t}/reserve7s/fixture?round=${e}`,className:`s7f-item${e===y?` active`:``}${a}`,children:[(0,l.jsx)(`span`,{className:`s7f-num`,children:e}),(0,l.jsx)(`span`,{className:`s7f-dot ${i}`})]},e)})}),(0,l.jsx)(`div`,{className:`s7f-round-hdr`,children:(0,l.jsxs)(`div`,{style:{display:`flex`,alignItems:`baseline`,gap:10},children:[(0,l.jsxs)(`h3`,{children:[`Round `,y]}),w===`completed`&&(0,l.jsx)(`span`,{className:`s7f-rh-badge s7f-rh-complete`,children:`Complete`}),w===`live`&&(0,l.jsxs)(`span`,{className:`s7f-rh-badge s7f-rh-live`,children:[(0,l.jsx)(`i`,{className:`bi bi-broadcast me-1`}),`Live`]}),(0,l.jsx)(`span`,{className:`s7f-title-badge`,children:x.label})]})}),(0,l.jsx)(`div`,{className:`s7f-list`,children:b.map(e=>{let t=e.status===`completed`&&(e.home_score||0)>(e.away_score||0),n=e.status===`completed`&&(e.away_score||0)>(e.home_score||0);return(0,l.jsxs)(`div`,{className:`s7f-row`,children:[(0,l.jsx)(`span`,{className:`s7f-team s7f-team-home${t?` won`:``}`,children:e.home_team?.name}),(0,l.jsx)(`div`,{className:`s7f-centre`,children:e.status===`completed`?(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(`span`,{className:`s7f-sc${t?` won`:` lost`}`,children:Math.round(e.home_score||0)}),(0,l.jsx)(`span`,{className:`s7f-sep`,children:`–`}),(0,l.jsx)(`span`,{className:`s7f-sc${n?` won`:` lost`}`,children:Math.round(e.away_score||0)})]}):(0,l.jsx)(`span`,{className:`s7f-vs`,children:`vs`})}),(0,l.jsx)(`span`,{className:`s7f-team s7f-team-away${n?` won`:``}`,children:e.away_team?.name})]},e.id)})})]}):(0,l.jsxs)(`div`,{className:`s7f-empty`,children:[(0,l.jsx)(`i`,{className:`bi bi-calendar-week`}),(0,l.jsx)(`h4`,{children:`No Reserve 7s fixture yet`}),(0,l.jsx)(`p`,{style:{fontSize:`.8rem`},children:`The 7s fixture auto-generates when the main season fixture is created.`}),S&&(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(`p`,{style:{fontSize:`.75rem`,color:`#484f58`,marginTop:8},children:`Or generate manually:`}),(0,l.jsxs)(`button`,{type:`button`,className:`s7f-generate-btn`,onClick:_,disabled:h,style:{display:`inline-block`,marginTop:12,padding:`8px 20px`,borderRadius:8,fontSize:`.8rem`,fontWeight:600,color:`#bc8cff`,background:`rgba(188,140,255,.08)`,border:`1px solid rgba(188,140,255,.2)`,cursor:`pointer`},children:[(0,l.jsx)(`i`,{className:`bi bi-plus-circle me-1`}),h?`Generating...`:`Generate 7s Fixture`]})]})]})]})}export{d as Reserve7sFixturePage};