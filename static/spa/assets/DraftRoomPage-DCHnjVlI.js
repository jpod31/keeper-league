...
`;function ae(e){if(e<=0)return`Starting soon...`;let t=Math.floor(e/1e3),n=Math.floor(t/86400),r=Math.floor(t%86400/3600),i=Math.floor(t%3600/60),a=t%60;return n>0?`${n}d ${r}h ${i}m`:r>0?`${r}h ${i}m ${a}s`:i>0?`${i}m ${a}s`:`${a}s`}function l(e){return e?e.split(`/`)[0].toLowerCase():`mid`}function oe(e){return e==null?`tier-empty`:e>=80?`tier-elite`:e>=70?`tier-good`:e>=60?`tier-ok`:`tier-low`}function se(e){return e==null?`tier-empty`:e>=80?`tier-elite`:e>=70?`tier-good`:e>=60?`tier-ok`:`tier-low`}function u(){let{leagueId:t}=e(),r=i(),[a,u]=(0,o.useState)(null),[d,ce]=(0,o.useState)(null),[le,ue]=(0,o.useState)(!0),[f,p]=(0,o.useState)(null),[m,h]=(0,o.useState)([]),[g,de]=(0,o.useState)(null),[fe,pe]=(0,o.useState)([]),[_,me]=(0,o.useState)(``),[v,he]=(0,o.useState)(``),[y,ge]=(0,o.useState)(``),[b,_e]=(0,o.useState)(``),[x,ve]=(0,o.useState)(`draft_score`),[S,C]=(0,o.useState)(`desc`),[w,T]=(0,o.useState)({}),[ye,be]=(0,o.useState)(!1),[xe,Se]=(0,o.useState)(!1),[E,Ce]=(0,o.useState)(`all`),[D,O]=(0,o.useState)(null),[we,k]=(0,o.useState)(!1),[Te,A]=(0,o.useState)(!1),[j,Ee]=(0,o.useState)(!1),[M,De]=(0,o.useState)(()=>typeof window<`u`&&window.innerWidth>=992),[N,P]=(0,o.useState)([]),[F,I]=(0,o.useState)(``),[L,R]=(0,o.useState)(0),z=(0,o.useRef)(null),B=(0,o.useRef)({}),[V,H]=(0,o.useState)(``),[Oe,ke]=(0,o.useState)(``),U=(0,o.useRef)(null);(0,o.useEffect)(()=>{ue(!0),ee(`/leagues/${t}/draft?format=json`).then(e=>{if(`empty_state`in e){ce(e);return}u(e),p(e.state),T(e.user_weights),Se(e.has_custom_weights),e.session.scheduled_start&&H(e.session.scheduled_start.slice(0,16))}).catch(()=>{}).finally(()=>ue(!1))},[t]),(0,o.useEffect)(()=>{U.current&&window.clearInterval(U.current);let e=a?.session.scheduled_start;if(!e||f?.status!==`scheduled`){ke(e?``:`No time set`);return}let t=()=>{ke(ae(new Date(e).getTime()-Date.now()))};return t(),U.current=window.setInterval(t,1e3),()=>{U.current&&window.clearInterval(U.current)}},[a?.session.scheduled_start,f?.status]);let W=(0,o.useCallback)(()=>{a?.user_team&&fetch(`/leagues/${t}/draft/api/position_needs`,{credentials:`same-origin`}).then(e=>e.json()).then(e=>{e.error||de(e)}).catch(()=>{})},[t,a?.user_team]),G=(0,o.useCallback)(()=>{a?.user_team&&fetch(`/leagues/${t}/draft/api/team_picks/${a.user_team.id}`,{credentials:`same-origin`}).then(e=>e.json()).then(pe).catch(()=>{})},[t,a?.user_team]),K=(0,o.useCallback)(()=>{let e=c.map(e=>`w_${e.key}=${w[e.key]??.2}`).join(`&`),n=b?800:200,r=new URLSearchParams;r.set(`q`,_),v&&r.set(`pos`,v),r.set(`limit`,String(n)),fetch(`/leagues/${t}/draft/api/available?${r.toString()}&${e}`,{credentials:`same-origin`}).then(e=>e.json()).then(e=>h(e)).catch(()=>h([]))},[t,_,v,b,w]);(0,o.useEffect)(()=>{a&&K()},[a,K]),(0,o.useEffect)(()=>{a&&(W(),G())},[a,W,G]),(0,o.useEffect)(()=>{a&&fetch(`/leagues/${t}/draft/api/chat_history`,{credentials:`same-origin`}).then(e=>e.json()).then(e=>P(e)).catch(()=>{})},[t,a]),(0,o.useEffect)(()=>{z.current&&(z.current.scrollTop=z.current.scrollHeight)},[N,M]);let{socket:q,state:Ae}=te({namespace:`/draft`,onConnect:e=>e.emit(`join_draft`,{league_id:Number(t)}),events:{draft_state:e=>{p(e),W(),G(),K()},pick_made:e=>{let t=e;p(e=>e&&{...e,pick_history:[t,...e.pick_history],picks_made:e.picks_made+1,picked_player_ids:t.player_id?[...e.picked_player_ids,t.player_id]:e.picked_player_ids}),P(e=>[...e,{team_name:t.team_name,message:t.is_pass?`${t.team_name} passed`:`${t.team_name} drafted ${t.player_name}`,is_system:!0}]),W(),K(),t.team_id===a?.user_team?.id&&G()},timer_tick:e=>{let{remaining:t}=e;p(e=>e&&{...e,timer_remaining:t})},draft_completed:e=>{p({...e,status:`completed`})},draft_chat_msg:e=>{let t=e;P(e=>[...e,t]),M||R(e=>e+1)},schedule_updated:e=>{let{scheduled_start:t}=e;u(e=>e&&{...e,session:{...e.session,scheduled_start:t}}),t&&H(t.slice(0,16))},error:e=>alert(e.message)}}),je=(0,o.useMemo)(()=>{let e=m.filter(e=>!(f&&e.id!=null&&f.picked_player_ids.includes(e.id)));y&&(e=e.filter(e=>e.age==null?!1:y===`30+`?e.age>=30:y===`25-30`?e.age>=25&&e.age<=30:e.age<parseInt(y))),b&&(e=e.filter(e=>e.afl_team===b));let t=S===`asc`?1:-1;return e.slice().sort((e,n)=>{let r=e[x],i=n[x];return r==null&&i==null?0:r==null?1:i==null?-1:typeof r==`string`&&typeof i==`string`?t*r.localeCompare(i):t*(r-i)}).slice(0,100)},[m,y,b,x,S,f]),Me=(0,o.useMemo)(()=>{let e=new Set;return m.forEach(t=>{t.afl_team&&e.add(t.afl_team)}),[...e].sort()},[m]),Ne=e=>{x===e?C(e=>e===`desc`?`asc`:`desc`):(ve(e),C([`name`,`position`,`afl_team`].includes(e)?`asc`:`desc`))},Pe=e=>x===e?S===`desc`?`bi-chevron-down`:`bi-chevron-up`:`bi-chevron-expand`,Fe=!!(a?.user_team&&f?.current_team_id===a.user_team.id),Ie=f?.status===`in_progress`&&(Fe||a?.is_commissioner&&j);function Le(e){return!g||!g.blocked_positions.length||!e?!1:e.split(`/`).map(e=>e.trim().toUpperCase()).every(e=>g.blocked_positions.includes(e))}function Re(e){if(!q?.connected){alert(`Not connected — refresh the page.`);return}O(e)}function ze(){D==null||!q||(q.emit(`make_pick`,{league_id:Number(t),player_id:D}),O(null))}function Be(){q?.emit(`pass_pick`,{league_id:Number(t)}),k(!1)}function Ve(e){if(!B.current[e]){let t=Object.keys(B.current).length;B.current[e]=re[t%re.length]}return B.current[e]}function He(){!F.trim()||!q||(q.emit(`draft_chat`,{league_id:Number(t),message:F.trim()}),I(``))}function Ue(){let e=!M;De(e),e&&R(0)}function We(e,t){T(n=>({...n,[e]:t}))}function Ge(){K()}async function Ke(){try{let e=await(await fetch(`/leagues/${t}/draft/api/save_weights`,{method:`POST`,credentials:`same-origin`,headers:{"Content-Type":`application/json`},body:JSON.stringify(w)})).json();e.status===`ok`&&(e.weights&&T(e.weights),Se(!0),K())}catch{}}function qe(){q?.emit(`update_schedule`,{league_id:Number(t),scheduled_start:V||null})}function Je(){q?.emit(`start_draft`,{league_id:Number(t)})}function Ye(){confirm(`Pause the draft? All timers will stop.`)&&q?.emit(`pause_draft`,{league_id:Number(t)})}function Xe(){q?.emit(`resume_draft`,{league_id:Number(t)})}function Ze(){confirm(`Undo the last pick?`)&&q?.emit(`undo_pick`,{league_id:Number(t)})}function Qe(){if(!confirm(`Are you sure you want to restart the draft?
...
This cannot be undone.`))return;let e=new FormData;e.set(`action`,`restart_draft`),fetch(`/leagues/${t}/draft/setup`,{method:`POST`,body:e,credentials:`same-origin`}).then(()=>r(`/leagues/${t}/settings`))}async function $e(){let e=new FormData;try{await fetch(`/leagues/${t}/draft/api/end`,{method:`POST`,body:e,credentials:`same-origin`}),A(!1)}catch{}}if(le)return(0,s.jsx)(ne,{});if(d)return(0,s.jsx)(`div`,{children:(0,s.jsxs)(`div`,{className:`empty-state`,children:[(0,s.jsx)(`div`,{className:`empty-icon`,children:(0,s.jsx)(`i`,{className:`bi bi-list-check`})}),(0,s.jsx)(`h4`,{children:`No draft scheduled yet`}),(0,s.jsx)(`p`,{children:d.is_commissioner?`Set up a draft session to get everyone in the room. While you wait, you can plan your picks in the player pool.`:`Your commissioner hasn't scheduled the next draft. You can still browse the player pool and plan your picks.`}),(0,s.jsxs)(`div`,{className:`d-flex justify-content-center gap-2 flex-wrap`,children:[(0,s.jsxs)(n,{to:`/leagues/${t}/player-pool`,className:`btn btn-primary btn-sm`,children:[(0,s.jsx)(`i`,{className:`bi bi-search me-1`}),`Browse player pool`]}),d.is_commissioner&&(0,s.jsxs)(n,{to:`/leagues/${t}/draft/setup`,className:`btn btn-outline-primary btn-sm`,children:[(0,s.jsx)(`i`,{className:`bi bi-calendar-plus me-1`}),`Set up draft`]}),(0,s.jsxs)(n,{to:`/leagues/${t}/player-ratings`,className:`btn btn-outline-secondary btn-sm`,children:[(0,s.jsx)(`i`,{className:`bi bi-star me-1`}),`Player ratings`]})]})]})});if(!a||!f)return(0,s.jsx)(`p`,{className:`text-danger`,children:`Failed to load draft room`});let{league:J,user_team:Y,is_commissioner:et,can_restart:tt,session:X}=a,Z=X.scheduled_start?new Date(X.scheduled_start):null,nt=Z?Z.toLocaleDateString(`en-AU`,{weekday:`short`,day:`numeric`,month:`short`})+`, `+Z.toLocaleTimeString(`en-AU`,{hour:`numeric`,minute:`2-digit`}):``,Q=D==null?null:m.find(e=>e.id===D),rt=Fe&&f.status===`in_progress`,$=f.status===`completed`,it=E===`mine`&&Y?f.pick_history.filter(e=>e.team_name===Y.name):f.pick_history;return(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`style`,{children:ie}),(0,s.jsxs)(`div`,{className:`page-header`,children:[(0,s.jsxs)(`div`,{className:`page-breadcrumb`,children:[(0,s.jsx)(n,{to:`/leagues/${t}`,children:J.name}),` / Draft Room`]}),(0,s.jsxs)(`div`,{className:`d-flex justify-content-between align-items-start flex-wrap gap-2`,children:[(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`h2`,{className:`mb-0`,children:`Live Draft`}),(0,s.jsxs)(`div`,{className:`d-flex align-items-center gap-3 mt-1`,children:[(0,s.jsx)(`span`,{className:`conn-dot${Ae===`connected`?``:` off`}`,title:Ae===`connected`?`Connected`:`Disconnected`}),(0,s.jsx)(`span`,{className:`status-pill status-${f.status.replace(`_`,`-`)}`,children:f.status}),(0,s.jsxs)(`span`,{className:`draft-header-info`,children:[J.draft_type.charAt(0).toUpperCase()+J.draft_type.slice(1),` · `,X.pick_timer_secs,`s timer`]})]})]}),et&&(0,s.jsxs)(`div`,{className:`d-flex gap-2 align-items-center flex-wrap`,children:[(0,s.jsxs)(`button`,{className:`btn btn-outline-warning btn-sm${j?` active`:``}`,onClick:()=>Ee(e=>!e),style:{fontSize:`.7rem`},title:`Pick on behalf of other teams`,children:[(0,s.jsx)(`i`,{className:`bi bi-shield${j?`-fill-check`:``} me-1`}),j?`Override ON`:`Override`]}),f.status===`scheduled`&&(0,s.jsxs)(`button`,{className:`btn btn-primary btn-sm`,onClick:Je,children:[(0,s.jsx)(`i`,{className:`bi bi-play-fill me-1`}),`Start Draft`]}),f.status===`in_progress`&&(0,s.jsxs)(`button`,{className:`btn btn-outline-secondary btn-sm`,onClick:Ye,children:[(0,s.jsx)(`i`,{className:`bi bi-pause-fill me-1`}),`Pause`]}),f.status===`paused`&&(0,s.jsxs)(`button`,{className:`btn btn-primary btn-sm`,onClick:Xe,children:[(0,s.jsx)(`i`,{className:`bi bi-play-fill me-1`}),`Resume`]}),f.picks_made>0&&(f.status===`in_progress`||f.status===`paused`)&&(0,s.jsxs)(`button`,{className:`btn btn-outline-info btn-sm`,onClick:Ze,style:{fontSize:`.7rem`},children:[(0,s.jsx)(`i`,{className:`bi bi-arrow-counterclockwise me-1`}),`Undo`]}),(f.status===`in_progress`||f.status===`paused`)&&(0,s.jsxs)(`button`,{className:`btn btn-outline-danger btn-sm`,onClick:()=>A(!0),style:{fontSize:`.7rem`},children:[(0,s.jsx)(`i`,{className:`bi bi-stop-fill me-1`}),`End Draft`]}),tt&&(0,s.jsxs)(`button`,{className:`btn btn-outline-danger btn-sm`,onClick:Qe,style:{fontSize:`.7rem`},children:[(0,s.jsx)(`i`,{className:`bi bi-arrow-counterclockwise me-1`}),`Restart`]})]})]})]}),f.status===`scheduled`?(0,s.jsxs)(`div`,{className:`draft-event`,children:[(0,s.jsxs)(`div`,{className:`d-flex align-items-center gap-3`,children:[(0,s.jsx)(`div`,{className:`draft-pick-badge scheduled`,children:(0,s.jsx)(`i`,{className:`bi bi-hourglass-split`})}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`div`,{className:`draft-banner-round`,children:`Draft Starts In`}),(0,s.jsx)(`div`,{className:`draft-event-countdown${Oe===`Starting soon...`?` soon`:``}`,children:Oe}),nt&&(0,s.jsx)(`div`,{className:`draft-event-time`,children:nt})]})]}),et&&(0,s.jsxs)(`div`,{className:`d-flex align-items-center gap-2`,children:[(0,s.jsx)(`input`,{type:`datetime-local`,className:`draft-filter-input`,value:V,onChange:e=>H(e.target.value),style:{width:`auto`}}),(0,s.jsxs)(`button`,{className:`btn btn-outline-warning btn-sm`,onClick:qe,style:{fontSize:`.7rem`,whiteSpace:`nowrap`},children:[(0,s.jsx)(`i`,{className:`bi bi-clock me-1`}),`Set Time`]})]})]}):(0,s.jsxs)(`div`,{className:`draft-banner${rt?` draft-banner-your-pick`:``}${$?` draft-banner-complete`:``}`,children:[(0,s.jsxs)(`div`,{className:`d-flex align-items-center gap-3`,children:[(0,s.jsx)(`div`,{className:`draft-pick-badge`,children:(0,s.jsx)(`span`,{children:f.current_pick||`-`})}),(0,s.jsxs)(`div`,{children:[(0,s.jsxs)(`div`,{className:`draft-banner-round`,children:[`Round `,f.current_round||`-`]}),(0,s.jsxs)(`div`,{className:`draft-banner-team`,children:[$?`Draft Complete`:f.current_team_name||`TBD`,rt&&(0,s.jsx)(`span`,{className:`draft-your-pick-pill`,children:`Your Pick`})]})]})]}),(0,s.jsxs)(`div`,{className:`draft-timer-block`,children:[(0,s.jsx)(`span`,{className:`draft-timer${(f.timer_remaining??0)<=10&&f.timer_remaining!=null?` timer-urgent`:``}`,children:$?`-`:f.timer_remaining??X.pick_timer_secs}),(0,s.jsx)(`span`,{className:`draft-timer-label`,children:`seconds`})]})]}),(0,s.jsxs)(`div`,{className:`row g-3`,children:[(0,s.jsx)(`div`,{className:`col-lg-7`,children:(0,s.jsxs)(`div`,{className:`card`,style:{display:`flex`,flexDirection:`column`},children:[(0,s.jsxs)(`div`,{className:`card-header`,children:[(0,s.jsxs)(`div`,{className:`d-flex justify-content-between align-items-center mb-2`,children:[(0,s.jsxs)(`h5`,{className:`mb-0 fw-bold`,style:{fontSize:`.95rem`},children:[(0,s.jsx)(`i`,{className:`bi bi-people me-2`,style:{color:`#8b949e`}}),`Available Players`]}),(0,s.jsxs)(`div`,{className:`d-flex gap-1 align-items-center`,children:[f.status===`in_progress`&&(0,s.jsxs)(`button`,{className:`btn btn-outline-warning py-0 px-2`,onClick:()=>k(!0),style:{fontSize:`.7rem`},title:`Pass on this pick`,children:[(0,s.jsx)(`i`,{className:`bi bi-skip-forward me-1`}),`Pass`]}),(0,s.jsxs)(`button`,{className:`btn btn-outline-secondary py-0 px-2`,type:`button`,onClick:()=>be(e=>!e),style:{fontSize:`.7rem`},title:`Adjust your draft value weights`,children:[(0,s.jsx)(`i`,{className:`bi bi-sliders me-1`}),`Values`]})]})]}),ye&&(0,s.jsxs)(`div`,{className:`draft-values-panel`,children:[c.map(({key:e,label:t})=>(0,s.jsxs)(`div`,{className:`draft-values-row`,children:[(0,s.jsx)(`span`,{className:`draft-values-label`,children:t}),(0,s.jsx)(`input`,{type:`range`,className:`draft-slider`,min:0,max:1,step:.01,value:w[e]??.2,onChange:t=>We(e,parseFloat(t.target.value))}),(0,s.jsxs)(`span`,{className:`draft-values-value`,children:[Math.round((w[e]??.2)*100),`%`]})]},e)),(0,s.jsxs)(`div`,{className:`draft-values-foot`,children:[(0,s.jsx)(`span`,{className:`draft-values-foot-meta`,children:xe?(0,s.jsx)(`span`,{className:`custom`,children:`Custom`}):`League defaults`}),(0,s.jsxs)(`div`,{className:`d-flex gap-1`,children:[(0,s.jsx)(`button`,{className:`btn btn-outline-secondary py-0 px-2`,onClick:Ge,style:{fontSize:`.7rem`},children:`Apply`}),(0,s.jsx)(`button`,{className:`btn btn-primary py-0 px-2`,onClick:Ke,style:{fontSize:`.7rem`},children:`Save`})]})]})]}),g&&Y&&(0,s.jsxs)(`div`,{className:`d-flex gap-2 mb-2 flex-wrap`,children:[[`DEF`,`MID`,`FWD`,`RUC`].map(e=>{let t=g.drafted[e]??0,n=g.required[e]??0,r=g.needs[e]??0,i=g.blocked_positions.includes(e);return(0,s.jsxs)(`span`,{className:`draft-need-chip ${i?`blocked`:r>0?`short`:`met`}`,title:i?`BLOCKED`:r>0?`${r} more needed`:`Requirement met`,children:[e,` `,t,`/`,n,i&&(0,s.jsx)(`i`,{className:`bi bi-lock-fill`,style:{fontSize:`.6rem`}})]},e)}),(0,s.jsxs)(`span`,{className:`draft-need-chip north`,title:`North Melbourne players drafted`,children:[`NM `,g.north_count??0]})]}),(0,s.jsxs)(`div`,{className:`row g-2`,children:[(0,s.jsx)(`div`,{className:`col`,children:(0,s.jsx)(`input`,{type:`text`,className:`draft-filter-input w-100`,placeholder:`Search players...`,value:_,onChange:e=>me(e.target.value)})}),(0,s.jsx)(`div`,{className:`col-auto`,children:(0,s.jsxs)(`select`,{className:`draft-filter-select`,value:v,onChange:e=>he(e.target.value),style:{width:`auto`},children:[(0,s.jsx)(`option`,{value:``,children:`All Pos`}),(0,s.jsx)(`option`,{value:`DEF`,children:`DEF`}),(0,s.jsx)(`option`,{value:`MID`,children:`MID`}),(0,s.jsx)(`option`,{value:`FWD`,children:`FWD`}),(0,s.jsx)(`option`,{value:`RUC`,children:`RUC`})]})}),(0,s.jsx)(`div`,{className:`col-auto`,children:(0,s.jsxs)(`select`,{className:`draft-filter-select`,value:y,onChange:e=>ge(e.target.value),style:{width:`auto`},children:[(0,s.jsx)(`option`,{value:``,children:`All Ages`}),(0,s.jsx)(`option`,{value:`21`,children:`U21`}),(0,s.jsx)(`option`,{value:`23`,children:`U23`}),(0,s.jsx)(`option`,{value:`25`,children:`U25`}),(0,s.jsx)(`option`,{value:`25-30`,children:`25-30`}),(0,s.jsx)(`option`,{value:`30+`,children:`30+`})]})}),(0,s.jsx)(`div`,{className:`col-auto`,children:(0,s.jsxs)(`select`,{className:`draft-filter-select`,value:b,onChange:e=>_e(e.target.value),style:{width:`auto`},children:[(0,s.jsx)(`option`,{value:``,children:`All Clubs`}),Me.map(e=>(0,s.jsx)(`option`,{value:e,children:e},e))]})})]})]}),(0,s.jsx)(`div`,{className:`card-body p-0`,style:{overflowY:`auto`,overflowX:`auto`,maxHeight:`70vh`},children:(0,s.jsxs)(`table`,{className:`table table-sm mb-0 draft-avail-tbl`,children:[(0,s.jsx)(`thead`,{children:(0,s.jsxs)(`tr`,{children:[[[`name`,`Player`],[`position`,`Pos`],[`afl_team`,`Team`],[`age`,`Age`],[`sc_avg`,`SC`],[`rating`,`Rtg`],[`potential`,`Pot`],[`draft_score`,`Value`]].map(([e,t])=>(0,s.jsxs)(`th`,{className:`sortable-th${x===e?` active-sort`:``}`,onClick:()=>Ne(e),children:[t,` `,(0,s.jsx)(`i`,{className:`bi sort-icon ${Pe(e)}`})]},e)),(0,s.jsx)(`th`,{})]})}),(0,s.jsx)(`tbody`,{children:je.map(e=>{let t=Le(e.position);return(0,s.jsxs)(`tr`,{className:t?`blocked`:void 0,children:[(0,s.jsx)(`td`,{className:`player-name`,children:e.name}),(0,s.jsx)(`td`,{children:e.position&&(0,s.jsx)(`span`,{className:`draft-pos-chip ${l(e.position)}`,children:e.position.split(`/`)[0]})}),(0,s.jsx)(`td`,{style:{color:`#97a3ba`},children:e.afl_team||``}),(0,s.jsx)(`td`,{style:{color:`#6c7892`},children:e.age??`-`}),(0,s.jsx)(`td`,{className:`stat-cell`,style:{color:`#b6c0d3`},children:e.sc_avg==null?`-`:e.sc_avg.toFixed(1)}),(0,s.jsx)(`td`,{className:`stat-cell`,children:(0,s.jsx)(`span`,{className:`draft-stat-chip ${oe(e.rating)}`,children:e.rating??`–`})}),(0,s.jsx)(`td`,{className:`stat-cell`,children:(0,s.jsx)(`span`,{className:`draft-stat-chip ${se(e.potential)}`,children:e.potential??`–`})}),(0,s.jsx)(`td`,{className:`stat-cell`,children:(0,s.jsx)(`span`,{className:`draft-stat-chip draft-score`,children:e.draft_score==null?`–`:e.draft_score.toFixed(1)})}),(0,s.jsx)(`td`,{children:(0,s.jsx)(`button`,{className:`btn btn-outline-primary btn-sm py-0 px-2`,onClick:()=>Ie&&Re(e.id),disabled:!Ie,title:t?`Position blocked — draft other positions first`:``,style:{fontSize:`.7rem`},children:t?(0,s.jsx)(`i`,{className:`bi bi-lock-fill`}):`Pick`})})]},e.id)})})]})})]})}),(0,s.jsx)(`div`,{className:`col-lg-5`,children:(0,s.jsxs)(`div`,{className:`draft-right-col`,children:[(0,s.jsxs)(`div`,{className:`card`,style:{flex:3},children:[(0,s.jsxs)(`div`,{className:`card-header d-flex justify-content-between align-items-center`,children:[(0,s.jsxs)(`div`,{className:`d-flex align-items-center gap-2`,children:[(0,s.jsxs)(`h5`,{className:`mb-0 fw-bold`,style:{fontSize:`.95rem`},children:[(0,s.jsx)(`i`,{className:`bi bi-clock-history me-2`,style:{color:`#8b949e`}}),`Pick History`]}),Y&&(0,s.jsxs)(`div`,{className:`btn-group btn-group-sm`,role:`group`,children:[(0,s.jsx)(`button`,{type:`button`,className:`btn btn-sm btn-outline-secondary${E===`all`?` active`:``}`,onClick:()=>Ce(`all`),style:{fontSize:`.7rem`,padding:`2px 8px`},children:`All`}),(0,s.jsx)(`button`,{type:`button`,className:`btn btn-sm btn-outline-secondary${E===`mine`?` active`:``}`,onClick:()=>Ce(`mine`),style:{fontSize:`.7rem`,padding:`2px 8px`},children:`Mine`})]})]}),(0,s.jsxs)(`span`,{className:`badge`,style:{background:`#21262d`,color:`#8b949e`,fontSize:`.75rem`},children:[f.picks_made,`/`,f.total_picks]})]}),(0,s.jsx)(`div`,{className:`card-body p-0`,style:{overflowY:`auto`},children:(0,s.jsxs)(`table`,{className:`table table-sm mb-0`,children:[(0,s.jsx)(`thead`,{className:`sticky-top`,children:(0,s.jsxs)(`tr`,{children:[(0,s.jsx)(`th`,{children:`#`}),(0,s.jsx)(`th`,{children:`Rd`}),(0,s.jsx)(`th`,{children:`Team`}),(0,s.jsx)(`th`,{children:`Player`}),(0,s.jsx)(`th`,{children:`Pos`}),(0,s.jsx)(`th`,{children:`AFL`})]})}),(0,s.jsx)(`tbody`,{children:it.map(e=>(0,s.jsxs)(`tr`,{className:Y&&e.team_id===Y.id?`draft-pick-row-mine`:void 0,children:[(0,s.jsx)(`td`,{style:{color:`#6c7892`},children:e.pick_number}),(0,s.jsx)(`td`,{style:{color:`#6c7892`},children:e.round}),(0,s.jsx)(`td`,{children:e.team_name}),e.is_pass?(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(`td`,{children:(0,s.jsx)(`span`,{className:`draft-pass-tag`,children:`PASS`})}),(0,s.jsx)(`td`,{}),(0,s.jsx)(`td`,{})]}):(0,s.jsxs)(s.Fragment,{children:[(0,s.jsxs)(`td`,{className:`player-name`,children:[e.player_name,e.is_auto_pick&&(0,s.jsx)(`span`,{className:`draft-auto-tag`,children:` (auto)`})]}),(0,s.jsx)(`td`,{children:e.player_position&&(0,s.jsx)(`span`,{className:`draft-pos-chip ${l(e.player_position)}`,children:e.player_position.split(`/`)[0]})}),(0,s.jsx)(`td`,{style:{color:`#97a3ba`},children:e.player_afl_team})]})]},e.pick_number))})]})})]}),Y&&(0,s.jsxs)(`div`,{className:`card`,style:{flex:2},children:[(0,s.jsxs)(`div`,{className:`card-header d-flex justify-content-between align-items-center`,children:[(0,s.jsxs)(`h5`,{className:`mb-0 fw-bold`,style:{fontSize:`.95rem`},children:[(0,s.jsx)(`i`,{className:`bi bi-person-badge me-2`,style:{color:`#58a6ff`}}),Y.name]}),(0,s.jsxs)(`span`,{className:`badge`,style:{background:`#21262d`,color:`#8b949e`,fontSize:`.75rem`},children:[fe.length,` players`]})]}),(0,s.jsx)(`div`,{className:`card-body p-0`,style:{overflowY:`auto`},children:(()=>{let e={DEF:[],MID:[],RUC:[],FWD:[],OTHER:[]};return fe.forEach(t=>{let n=(t.player_position||``).split(`/`)[0].toUpperCase();n===`DEF`||n===`MID`||n===`RUC`||n===`FWD`?e[n].push(t):e.OTHER.push(t)}),[`DEF`,`MID`,`RUC`,`FWD`,`OTHER`].map(t=>e[t].length===0?null:(0,s.jsxs)(`div`,{children:[(0,s.jsxs)(`div`,{className:`draft-yt-section ${t===`OTHER`?``:t.toLowerCase()}`,children:[t,` · `,e[t].length]}),(0,s.jsx)(`table`,{className:`table table-sm mb-0`,children:(0,s.jsx)(`tbody`,{children:e[t].map(e=>(0,s.jsxs)(`tr`,{children:[(0,s.jsx)(`td`,{style:{color:`#6c7892`,width:30},children:e.pick_number}),(0,s.jsx)(`td`,{className:`player-name`,children:e.player_name}),(0,s.jsx)(`td`,{style:{width:50},children:e.player_position&&(0,s.jsx)(`span`,{className:`draft-pos-chip ${l(e.player_position)}`,children:e.player_position.split(`/`)[0]})}),(0,s.jsx)(`td`,{style:{color:`#97a3ba`,width:60},children:e.player_afl_team})]},e.pick_number))})})]},t))})()})]}),(0,s.jsxs)(`div`,{className:`card draft-chat-card`,children:[(0,s.jsxs)(`div`,{className:`card-header d-flex justify-content-between align-items-center`,style:{cursor:`pointer`},onClick:Ue,children:[(0,s.jsxs)(`h5`,{className:`mb-0 fw-bold`,style:{fontSize:`.95rem`},children:[(0,s.jsx)(`i`,{className:`bi bi-chat-dots me-2`,style:{color:`#d29922`}}),`Draft Chat`]}),(0,s.jsxs)(`div`,{className:`d-flex align-items-center gap-2`,children:[L>0&&(0,s.jsx)(`span`,{className:`badge`,style:{background:`#f85149`,fontSize:`.6rem`,borderRadius:8},children:L}),(0,s.jsx)(`i`,{className:`bi bi-chevron-down${M?``:` chat-toggle-collapsed`}`,style:{color:`#8b949e`,fontSize:`.75rem`,transition:`transform .2s`}})]})]}),M&&(0,s.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`},children:[(0,s.jsx)(`div`,{ref:z,id:`chat-messages`,className:`card-body p-0`,style:{overflowY:`auto`,padding:`.5rem !important`,maxHeight:180},children:N.length===0?(0,s.jsx)(`div`,{className:`text-center py-3`,style:{color:`#484f58`,fontSize:`.75rem`},children:(0,s.jsx)(`i`,{className:`bi bi-chat-dots`,style:{fontSize:`1.2rem`}})}):N.map((e,t)=>e.is_system?(0,s.jsx)(`div`,{className:`chat-msg-system`,children:e.message},t):(0,s.jsxs)(`div`,{className:`chat-msg`,children:[(0,s.jsx)(`span`,{className:`chat-msg-name`,style:{color:Ve(e.team_name)},children:e.team_name}),(0,s.jsx)(`span`,{className:`chat-msg-text`,children:e.message})]},t))}),(0,s.jsxs)(`div`,{style:{borderTop:`1px solid rgba(110,130,180,.12)`,padding:`8px 12px`,display:`flex`,gap:6},children:[(0,s.jsx)(`input`,{type:`text`,className:`draft-filter-input flex-grow-1`,placeholder:`Say something...`,maxLength:500,value:F,onChange:e=>I(e.target.value),onKeyDown:e=>{e.key===`Enter`&&(e.preventDefault(),He())}}),(0,s.jsx)(`button`,{className:`btn btn-sm btn-primary`,onClick:He,style:{padding:`4px 12px`,whiteSpace:`nowrap`},children:(0,s.jsx)(`i`,{className:`bi bi-send`})})]})]})]})]})})]}),D!=null&&Q&&(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(`div`,{onClick:()=>O(null),style:{position:`fixed`,inset:0,background:`rgba(0,0,0,.55)`,zIndex:1055}}),(0,s.jsxs)(`div`,{role:`dialog`,"aria-modal":`true`,style:{position:`fixed`,top:`50%`,left:`50%`,transform:`translate(-50%,-50%)`,zIndex:1060,width:`90%`,maxWidth:360,background:`#161b22`,border:`1px solid #30363d`,borderRadius:12},children:[(0,s.jsxs)(`div`,{style:{borderBottom:`1px solid #30363d`,padding:`.75rem 1rem`,display:`flex`,justifyContent:`space-between`,alignItems:`center`},children:[(0,s.jsx)(`h6`,{className:`fw-bold mb-0`,style:{fontSize:`.9rem`},children:`Confirm Pick`}),(0,s.jsx)(`button`,{type:`button`,className:`btn-close btn-close-white`,onClick:()=>O(null)})]}),(0,s.jsxs)(`div`,{className:`text-center`,style:{padding:`1rem`},children:[(0,s.jsx)(`div`,{style:{fontSize:`1.1rem`,fontWeight:700,color:`#c9d1d9`},children:Q.name}),(0,s.jsxs)(`div`,{className:`d-flex justify-content-center gap-2 mt-1`,children:[(0,s.jsx)(`span`,{className:`pos-badge badge-${l(Q.position)}`,children:Q.position}),(0,s.jsx)(`span`,{style:{fontSize:`.8rem`,color:`#8b949e`},children:Q.afl_team})]})]}),(0,s.jsxs)(`div`,{style:{borderTop:`1px solid #30363d`,padding:`.75rem 1rem`,display:`flex`,gap:`.5rem`},children:[(0,s.jsx)(`button`,{type:`button`,className:`btn btn-outline-secondary btn-sm flex-fill`,onClick:()=>O(null),children:`Cancel`}),(0,s.jsx)(`button`,{type:`button`,className:`btn btn-primary btn-sm flex-fill`,onClick:ze,children:`Confirm`})]})]})]}),we&&(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(`div`,{onClick:()=>k(!1),style:{position:`fixed`,inset:0,background:`rgba(0,0,0,.55)`,zIndex:1055}}),(0,s.jsxs)(`div`,{role:`dialog`,"aria-modal":`true`,style:{position:`fixed`,top:`50%`,left:`50%`,transform:`translate(-50%,-50%)`,zIndex:1060,width:`90%`,maxWidth:360,background:`#161b22`,border:`1px solid #30363d`,borderRadius:12},children:[(0,s.jsxs)(`div`,{style:{borderBottom:`1px solid #30363d`,padding:`.75rem 1rem`,display:`flex`,justifyContent:`space-between`,alignItems:`center`},children:[(0,s.jsx)(`h6`,{className:`fw-bold mb-0`,style:{fontSize:`.9rem`},children:`Pass Pick?`}),(0,s.jsx)(`button`,{type:`button`,className:`btn-close btn-close-white`,onClick:()=>k(!1)})]}),(0,s.jsx)(`div`,{className:`text-center`,style:{padding:`1rem`},children:(0,s.jsx)(`div`,{style:{fontSize:`.85rem`,color:`#8b949e`},children:`Are you sure you want to pass on this pick? You won't draft a player this round.`})}),(0,s.jsxs)(`div`,{style:{borderTop:`1px solid #30363d`,padding:`.75rem 1rem`,display:`flex`,gap:`.5rem`},children:[(0,s.jsx)(`button`,{type:`button`,className:`btn btn-outline-secondary btn-sm flex-fill`,onClick:()=>k(!1),children:`Cancel`}),(0,s.jsx)(`button`,{type:`button`,className:`btn btn-warning btn-sm flex-fill`,onClick:Be,children:`Pass`})]})]})]}),Te&&(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(`div`,{onClick:()=>A(!1),style:{position:`fixed`,inset:0,background:`rgba(0,0,0,.55)`,zIndex:1055}}),(0,s.jsxs)(`div`,{role:`dialog`,"aria-modal":`true`,style:{position:`fixed`,top:`50%`,left:`50%`,transform:`translate(-50%,-50%)`,zIndex:1060,width:`90%`,maxWidth:360,background:`#161b22`,border:`1px solid #30363d`,borderRadius:12},children:[(0,s.jsxs)(`div`,{style:{borderBottom:`1px solid #30363d`,padding:`.75rem 1rem`,display:`flex`,justifyContent:`space-between`,alignItems:`center`},children:[(0,s.jsx)(`h6`,{className:`fw-bold mb-0`,style:{fontSize:`.9rem`,color:`#f85149`},children:`End Draft Early?`}),(0,s.jsx)(`button`,{type:`button`,className:`btn-close btn-close-white`,onClick:()=>A(!1)})]}),(0,s.jsx)(`div`,{className:`text-center`,style:{padding:`1rem`},children:(0,s.jsxs)(`div`,{style:{fontSize:`.85rem`,color:`#8b949e`},children:[`All remaining picks will be marked as `,(0,s.jsx)(`strong`,{style:{color:`#d29922`},children:`PASS`}),` and the draft will be completed immediately.`]})}),(0,s.jsxs)(`div`,{style:{borderTop:`1px solid #30363d`,padding:`.75rem 1rem`,display:`flex`,gap:`.5rem`},children:[(0,s.jsx)(`button`,{type:`button`,className:`btn btn-outline-secondary btn-sm flex-fill`,onClick:()=>A(!1),children:`Cancel`}),(0,s.jsx)(`button`,{type:`button`,className:`btn btn-danger btn-sm flex-fill`,onClick:$e,children:`End Draft`})]})]})]})]})}export{u as DraftRoomPage};