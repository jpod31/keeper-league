import{a as e}from"./chunk-BEqpzyXh.js";import{n as t,t as n}from"./jsx-runtime-BwJb0T-f.js";import{n as r,u as i}from"./chunk-QFMPRPBF-tanTk093.js";import{t as a}from"./useFetch-DtmO9Zkn.js";import{t as o}from"./LeagueSubnav-DXh8C35i.js";var s=e(t(),1),c=n();function l(){return(0,c.jsxs)(`div`,{className:`stsk`,children:[(0,c.jsxs)(`div`,{className:`stsk-header`,children:[(0,c.jsx)(`span`,{className:`kl-skel stsk-title`}),(0,c.jsx)(`span`,{className:`kl-skel stsk-meta`})]}),(0,c.jsx)(`div`,{className:`stsk-list`,children:Array.from({length:10}).map((e,t)=>(0,c.jsxs)(`div`,{className:`stsk-row`,children:[(0,c.jsx)(`span`,{className:`kl-skel stsk-rank`}),(0,c.jsx)(`span`,{className:`kl-skel stsk-name`}),(0,c.jsx)(`span`,{className:`kl-skel stsk-cell`}),(0,c.jsx)(`span`,{className:`kl-skel stsk-cell`}),(0,c.jsx)(`span`,{className:`kl-skel stsk-cell`})]},t))})]})}var u=[{hex:`#3a7dc4`,rgb:`58,125,196`},{hex:`#b87f3d`,rgb:`184,127,61`},{hex:`#8a6db8`,rgb:`138,109,184`},{hex:`#3d8c63`,rgb:`61,140,99`},{hex:`#c2932f`,rgb:`194,147,47`},{hex:`#b85a4a`,rgb:`184,90,74`},{hex:`#3d8a9c`,rgb:`61,138,156`},{hex:`#9d5878`,rgb:`157,88,120`}];function d(e){return u[(e||0)%u.length]}function f(e){return(e||`Steady`).toLowerCase().replace(/\s+/g,``)}function p(e){let t=(e||``).toLowerCase();return t.includes(`supercoach`)?`sc`:t.includes(`fantasy`)?`af`:t.includes(`ultimate`)?`uf`:t.includes(`hybrid`)?`hybrid`:`custom`}var m=`
...
`,h={pos:`asc`,name:`asc`,pr:`asc`,wins:`desc`,mov:`desc`,pf:`desc`,pa:`desc`,pct:`desc`,pts:`desc`};function g({mode:e=`main`}={}){let{leagueId:t}=i(),n=e===`sevens`,{data:u,loading:g}=a(n?`/leagues/${t}/reserve7s/standings?format=json`:`/leagues/${t}/standings?format=json`),[_,v]=(0,s.useState)(`pos`),[y,b]=(0,s.useState)(`asc`);function x(e){e===_?b(e=>e===`asc`?`desc`:`asc`):(v(e),b(h[e]))}let S=u?.standings??[],C=u?.rankings??[],w=(0,s.useMemo)(()=>{let e={};for(let t of C)e[t.team_id]=t;return e},[C]),T=(0,s.useMemo)(()=>{let e=new Map;return S.forEach((t,n)=>e.set(t.team_id,n+1)),e},[S]),E=(0,s.useMemo)(()=>{let e=[...S];return e.sort((e,t)=>{let n=0,r=0;switch(_){case`pos`:n=T.get(e.team_id)??999,r=T.get(t.team_id)??999;break;case`name`:n=(e.team?.name||``).toLowerCase(),r=(t.team?.name||``).toLowerCase();break;case`pr`:n=w[e.team_id]?.rank??999,r=w[t.team_id]?.rank??999;break;case`wins`:n=e.wins*1e3-e.losses,r=t.wins*1e3-t.losses;break;case`mov`:n=w[e.team_id]?.movement??0,r=w[t.team_id]?.movement??0;break;case`pf`:n=e.points_for,r=t.points_for;break;case`pa`:n=e.points_against,r=t.points_against;break;case`pct`:n=e.percentage,r=t.percentage;break;case`pts`:n=e.ladder_points,r=t.ladder_points;break}let i=0;return i=typeof n==`string`&&typeof r==`string`?n.localeCompare(r):n-r,y===`asc`?i:-i}),e},[S,_,y,T,w]);if(g)return(0,c.jsx)(l,{});if(!u)return(0,c.jsx)(`p`,{className:`text-danger`,children:`Failed to load standings`});let{finals_teams:D,scoring:O,user_team_id:k}=u,A=u.ranking_details??{},j=u.team_form??{},M=C.length>0,N=p(O.label),P=_===`pos`&&y===`asc`&&D>0,F=({field:e,children:t})=>{let n=_===e;return(0,c.jsxs)(`button`,{type:`button`,className:`lad-sort${n?` active`:``}`,onClick:()=>x(e),children:[t,(0,c.jsx)(`span`,{className:`lad-sort-chev`,children:n?y===`asc`?`▲`:`▼`:`▾`})]})};return(0,c.jsxs)(`div`,{className:n?`lad-sevens`:``,children:[(0,c.jsx)(`style`,{children:m}),(0,c.jsx)(`div`,{className:`d-none d-lg-block`,children:(0,c.jsx)(o,{active:`ladder`,leagueId:t})}),(0,c.jsxs)(`div`,{className:`lad-comp-toggle`,children:[n?(0,c.jsx)(r,{to:`/leagues/${t}/standings`,className:`lad-comp-btn`,children:`Main`}):(0,c.jsx)(`span`,{className:`lad-comp-btn active`,children:`Main`}),n?(0,c.jsx)(`span`,{className:`lad-comp-btn active`,children:`7s`}):(0,c.jsx)(r,{to:`/leagues/${t}/reserve7s/standings`,className:`lad-comp-btn`,children:`7s`})]}),S.length===0?(0,c.jsxs)(`div`,{className:`lad-empty`,children:[(0,c.jsx)(`i`,{className:`bi bi-bar-chart`}),(0,c.jsx)(`h4`,{children:`No teams yet`}),(0,c.jsx)(`p`,{children:`Teams will appear here once they join the league.`})]}):(0,c.jsxs)(c.Fragment,{children:[(0,c.jsxs)(`div`,{className:`lad-head`,children:[(0,c.jsx)(F,{field:`pos`,children:`#`}),(0,c.jsx)(F,{field:`name`,children:`Team`}),(0,c.jsx)(`span`,{children:`Status`}),(0,c.jsx)(F,{field:`pr`,children:`PR`}),(0,c.jsx)(F,{field:`wins`,children:`W–L`}),(0,c.jsx)(`span`,{children:`Form · 5`}),(0,c.jsx)(F,{field:`mov`,children:`Mov.`}),(0,c.jsx)(F,{field:`pf`,children:O.for_label}),(0,c.jsx)(F,{field:`pa`,children:O.against_label}),(0,c.jsx)(F,{field:`pct`,children:O.pct_label}),(0,c.jsx)(F,{field:`pts`,children:`Pts`})]}),(0,c.jsx)(`div`,{className:`lad-wrap`,children:E.map(e=>{let n=T.get(e.team_id)??0,i=w[e.team_id],a=A[String(e.team_id)],o=j[String(e.team_id)]||[],s=k!=null&&e.team_id===k,l=P&&n===D,u=d(e.team_id),p=i?.movement??0,m=a?.headline,h=f(m||``);return(0,c.jsxs)(`div`,{children:[(0,c.jsxs)(r,{to:`/leagues/${t}/team/${e.team_id}`,className:`lad-row${s?` mine`:``}`,style:{"--lad-accent":u.hex,"--lad-accent-rgb":u.rgb},children:[(0,c.jsx)(`span`,{className:`lad-rank${n<=3?` lad-rank-${n}`:``}`,children:n}),(0,c.jsx)(`span`,{className:`lad-team-name`,children:e.team?.name}),(0,c.jsx)(`span`,{className:`lad-status`,children:m?(0,c.jsx)(`span`,{className:`lad-pill lad-pill-${h}`,children:m}):(0,c.jsx)(`span`,{className:`lad-status-empty`,children:`—`})}),(0,c.jsx)(`span`,{className:`lad-pr`,children:i?.rank?(0,c.jsx)(`span`,{className:`lad-pr-chip${i.rank<=3?` tier-${i.rank}`:``}`,children:i.rank}):(0,c.jsx)(`span`,{className:`lad-pr-empty`,children:`—`})}),(0,c.jsxs)(`span`,{className:`lad-wl`,children:[(0,c.jsx)(`span`,{className:`w`,children:e.wins}),(0,c.jsx)(`span`,{className:`sep`,children:`–`}),(0,c.jsx)(`span`,{className:`l`,children:e.losses}),e.draws>0&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(`span`,{className:`sep`,children:`–`}),(0,c.jsx)(`span`,{className:`d`,children:e.draws})]})]}),(0,c.jsx)(`div`,{className:`lad-form`,children:(o.length>0?o:[,,,,,].fill(``)).slice(-5).map((e,t)=>(0,c.jsx)(`span`,{className:`lad-form-dot ${e}`,title:e||`No result`},t))}),(0,c.jsxs)(`span`,{className:`lad-momentum ${p>0?`up`:p<0?`down`:`flat`}`,children:[p>0&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(`i`,{className:`bi bi-caret-up-fill`,style:{fontSize:`.6rem`}}),p]}),p<0&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(`i`,{className:`bi bi-caret-down-fill`,style:{fontSize:`.6rem`}}),Math.abs(p)]}),p===0&&(0,c.jsx)(c.Fragment,{children:`—`})]}),(0,c.jsx)(`span`,{className:`lad-num`,children:e.points_for>0?Math.round(e.points_for):`–`}),(0,c.jsx)(`span`,{className:`lad-num`,children:e.points_against>0?Math.round(e.points_against):`–`}),(0,c.jsx)(`span`,{className:`lad-num`,children:e.percentage>0?(0,c.jsxs)(`span`,{style:e.percentage>=110?{color:`#6db38a`}:e.percentage<90?{color:`#d68a7e`}:void 0,children:[e.percentage.toFixed(1),(0,c.jsx)(`span`,{className:`unit`,children:`%`})]}):`–`}),(0,c.jsx)(`span`,{className:`lad-num lad-num-strong`,children:e.ladder_points})]}),l&&(0,c.jsx)(`div`,{className:`lad-cut`,children:(0,c.jsxs)(`span`,{children:[(0,c.jsx)(`i`,{className:`bi bi-trophy-fill`}),`Finals cut · top `,D]})},`cut-${e.team_id}`)]},e.team_id)})}),(0,c.jsxs)(`div`,{className:`lad-foot`,children:[(0,c.jsx)(`span`,{children:M&&C[0]?`Round ${C[0].afl_round} · Form, momentum & headlines updated weekly`:``}),(0,c.jsx)(`span`,{className:`scoring-tag`,"data-type":N,children:O.label})]})]})]})}export{g as t};