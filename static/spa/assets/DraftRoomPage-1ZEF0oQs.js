...
`;function se(e){if(e<=0)return`Starting soon...`;let t=Math.floor(e/1e3),n=Math.floor(t/86400),r=Math.floor(t%86400/3600),i=Math.floor(t%3600/60),a=t%60;return n>0?`${n}d ${r}h ${i}m`:r>0?`${r}h ${i}m ${a}s`:i>0?`${i}m ${a}s`:`${a}s`}function c(e){return e?e.split(`/`)[0].toLowerCase():`mid`}function ce(e){return e==null?`tier-empty`:e>=80?`tier-elite`:e>=70?`tier-good`:e>=60?`tier-ok`:`tier-low`}function le(e){return e==null?`tier-empty`:e>=80?`tier-elite`:e>=70?`tier-good`:e>=60?`tier-ok`:`tier-low`}function l(){let{leagueId:e}=t(),n=a(),[i,l]=(0,o.useState)(null),[u,ue]=(0,o.useState)(null),[de,fe]=(0,o.useState)(!0),[d,f]=(0,o.useState)(null),[p,pe]=(0,o.useState)([]),[m,me]=(0,o.useState)(null),[he,ge]=(0,o.useState)([]),[h,_e]=(0,o.useState)(``),[g,ve]=(0,o.useState)(``),[_,ye]=(0,o.useState)(``),[v,be]=(0,o.useState)(``),[y,xe]=(0,o.useState)(`draft_score`),[b,Se]=(0,o.useState)(`desc`),[x,S]=(0,o.useState)({}),[Ce,we]=(0,o.useState)(!1),[Te,Ee]=(0,o.useState)(!1),[C,De]=(0,o.useState)(`all`),[w,T]=(0,o.useState)(null),[Oe,E]=(0,o.useState)(!1),[ke,D]=(0,o.useState)(!1),[O,Ae]=(0,o.useState)(!1),[k,je]=(0,o.useState)([]),[A,Me]=(0,o.useState)(`queue`),Ne=ne(e),j=(0,o.useMemo)(()=>new Set(k.map(e=>e.player_id)),[k]),[M,Pe]=(0,o.useState)(()=>typeof window<`u`&&window.innerWidth>=992),[N,P]=(0,o.useState)([]),[F,Fe]=(0,o.useState)(``),[Ie,Le]=(0,o.useState)(0),I=(0,o.useRef)(null),L=(0,o.useRef)({}),[Re,R]=(0,o.useState)(``),[ze,Be]=(0,o.useState)(``),z=(0,o.useRef)(null);(0,o.useEffect)(()=>{fe(!0),ee(`/leagues/${e}/draft?format=json`).then(e=>{if(`empty_state`in e){ue(e);return}l(e),f(e.state),S(e.user_weights),Ee(e.has_custom_weights),e.session.scheduled_start&&R(e.session.scheduled_start.slice(0,16))}).catch(()=>{}).finally(()=>fe(!1))},[e]),(0,o.useEffect)(()=>{z.current&&window.clearInterval(z.current);let e=i?.session.scheduled_start;if(!e||d?.status!==`scheduled`){Be(e?``:`No time set`);return}let t=()=>{Be(se(new Date(e).getTime()-Date.now()))};return t(),z.current=window.setInterval(t,1e3),()=>{z.current&&window.clearInterval(z.current)}},[i?.session.scheduled_start,d?.status]);let B=(0,o.useCallback)(()=>{i?.user_team&&fetch(`/leagues/${e}/draft/api/position_needs`,{credentials:`same-origin`}).then(e=>e.json()).then(e=>{e.error||me(e)}).catch(()=>{})},[e,i?.user_team]),V=(0,o.useCallback)(()=>{i?.user_team&&fetch(`/leagues/${e}/draft/api/team_picks/${i.user_team.id}`,{credentials:`same-origin`}).then(e=>e.json()).then(e=>ge(Array.isArray(e)?e:[])).catch(()=>{})},[e,i?.user_team]),H=(0,o.useCallback)(()=>{let t=ie.map(e=>`w_${e.key}=${x[e.key]??.2}`).join(`&`),n=v?800:200,r=new URLSearchParams;r.set(`q`,h),g&&r.set(`pos`,g),r.set(`limit`,String(n)),fetch(`/leagues/${e}/draft/api/available?${r.toString()}&${t}`,{credentials:`same-origin`}).then(e=>e.json()).then(e=>pe(Array.isArray(e)?e:[])).catch(()=>pe([]))},[e,h,g,v,x]),U=(0,o.useCallback)(()=>{i?.user_team&&fetch(`/leagues/${e}/draft/api/queue`,{credentials:`same-origin`}).then(e=>e.json()).then(e=>je(Array.isArray(e)?e:[])).catch(()=>{})},[e,i?.user_team]),Ve=(0,o.useCallback)(t=>{fetch(`/leagues/${e}/draft/api/queue`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({player_id:t}),credentials:`same-origin`}).then(()=>U()).catch(()=>{})},[e,U]),W=(0,o.useCallback)(t=>{fetch(`/leagues/${e}/draft/api/queue`,{method:`DELETE`,headers:{"Content-Type":`application/json`},body:JSON.stringify({player_id:t}),credentials:`same-origin`}).then(()=>U()).catch(()=>{})},[e,U]);(0,o.useEffect)(()=>{i&&H()},[i,H]),(0,o.useEffect)(()=>{i&&(B(),V(),U())},[i,B,V,U]),(0,o.useEffect)(()=>{i&&fetch(`/leagues/${e}/draft/api/chat_history`,{credentials:`same-origin`}).then(e=>e.json()).then(e=>P(Array.isArray(e)?e:[])).catch(()=>{})},[e,i]),(0,o.useEffect)(()=>{I.current&&(I.current.scrollTop=I.current.scrollHeight)},[N,M]);let{socket:G,state:He}=te({namespace:`/draft`,onConnect:t=>t.emit(`join_draft`,{league_id:Number(e)}),events:{draft_state:e=>{f(e),B(),V(),H(),U()},pick_made:e=>{let t=e;f(e=>e&&{...e,pick_history:[t,...e.pick_history],picks_made:e.picks_made+1,picked_player_ids:t.player_id?[...e.picked_player_ids,t.player_id]:e.picked_player_ids}),P(e=>[...e,{team_name:t.team_name,message:t.is_pass?`${t.team_name} passed`:`${t.team_name} drafted ${t.player_name}`,is_system:!0}]),B(),H(),t.team_id===i?.user_team?.id&&V()},timer_tick:e=>{let{remaining:t}=e;f(e=>e&&{...e,timer_remaining:t})},draft_completed:e=>{f({...e,status:`completed`})},draft_chat_msg:e=>{let t=e;P(e=>[...e,t]),M||Le(e=>e+1)},schedule_updated:e=>{let{scheduled_start:t}=e;l(e=>e&&{...e,session:{...e.session,scheduled_start:t}}),t&&R(t.slice(0,16))},error:e=>alert(e.message)}}),Ue=(0,o.useMemo)(()=>{let e=p.filter(e=>!(d&&e.id!=null&&d.picked_player_ids.includes(e.id)));_&&(e=e.filter(e=>e.age==null?!1:_===`30+`?e.age>=30:_===`25-30`?e.age>=25&&e.age<=30:e.age<parseInt(_))),v&&(e=e.filter(e=>e.afl_team===v));let t=b===`asc`?1:-1;return e.slice().sort((e,n)=>{let r=e[y],i=n[y];return r==null&&i==null?0:r==null?1:i==null?-1:typeof r==`string`&&typeof i==`string`?t*r.localeCompare(i):t*(r-i)}).slice(0,100)},[p,_,v,y,b,d]),We=(0,o.useMemo)(()=>{let e=new Set;return p.forEach(t=>{t.afl_team&&e.add(t.afl_team)}),[...e].sort()},[p]),Ge=e=>{y===e?Se(e=>e===`desc`?`asc`:`desc`):(xe(e),Se([`name`,`position`,`afl_team`].includes(e)?`asc`:`desc`))},Ke=e=>y===e?b===`desc`?`bi-chevron-down`:`bi-chevron-up`:`bi-chevron-expand`,qe=!!(i?.user_team&&d?.current_team_id===i.user_team.id),K=d?.status===`in_progress`&&(qe||i?.is_commissioner&&O);function Je(e){return!m||!m.blocked_positions.length||!e?!1:e.split(`/`).map(e=>e.trim().toUpperCase()).every(e=>m.blocked_positions.includes(e))}function q(e){if(!G?.connected){alert(`Not connected — refresh the page.`);return}T(e)}function Ye(){w==null||!G||(G.emit(`make_pick`,{league_id:Number(e),player_id:w}),T(null))}function Xe(){G?.emit(`pass_pick`,{league_id:Number(e)}),E(!1)}function Ze(e){if(!L.current[e]){let t=Object.keys(L.current).length;L.current[e]=ae[t%ae.length]}return L.current[e]}function Qe(){!F.trim()||!G||(G.emit(`draft_chat`,{league_id:Number(e),message:F.trim()}),Fe(``))}function $e(){let e=!M;Pe(e),e&&Le(0)}function et(e,t){S(n=>({...n,[e]:t}))}function tt(){H()}async function nt(){try{let t=await(await fetch(`/leagues/${e}/draft/api/save_weights`,{method:`POST`,credentials:`same-origin`,headers:{"Content-Type":`application/json`},body:JSON.stringify(x)})).json();t.status===`ok`&&(t.weights&&S(t.weights),Ee(!0),H())}catch{}}function rt(){G?.emit(`update_schedule`,{league_id:Number(e),scheduled_start:Re||null})}function it(){G?.emit(`start_draft`,{league_id:Number(e)})}function at(){confirm(`Pause the draft? All timers will stop.`)&&G?.emit(`pause_draft`,{league_id:Number(e)})}function ot(){G?.emit(`resume_draft`,{league_id:Number(e)})}function st(){confirm(`Undo the last pick?`)&&G?.emit(`undo_pick`,{league_id:Number(e)})}function ct(){if(!confirm(`Are you sure you want to restart the draft?
