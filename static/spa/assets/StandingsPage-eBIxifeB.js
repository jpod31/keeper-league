...
`;function f({mode:n=`main`}={}){let{leagueId:s}=e(),f=n===`sevens`,{data:p,loading:m}=i(f?`/leagues/${s}/reserve7s/standings?format=json`:`/leagues/${s}/standings?format=json`);if(m)return(0,o.jsx)(r,{text:`Loading standings...`});if(!p)return(0,o.jsx)(`p`,{className:`text-danger`,children:`Failed to load standings`});let{standings:h,finals_teams:g,scoring:_,rankings:v,ranking_details:y,team_form:b,user_team_id:x}=p,S=v&&v.length>0,C=u(_.label),w={};for(let e of v||[])w[e.team_id]=e;return(0,o.jsxs)(`div`,{className:f?`lad-sevens`:``,children:[(0,o.jsx)(`style`,{children:d}),(0,o.jsx)(`div`,{className:`d-none d-lg-block`,children:(0,o.jsx)(a,{active:`ladder`,leagueId:s})}),(0,o.jsxs)(`div`,{className:`lad-comp-toggle`,children:[f?(0,o.jsx)(t,{to:`/leagues/${s}/standings`,className:`lad-comp-btn`,children:`Main`}):(0,o.jsx)(`span`,{className:`lad-comp-btn active`,children:`Main`}),f?(0,o.jsx)(`span`,{className:`lad-comp-btn active`,children:`7s`}):(0,o.jsx)(t,{to:`/leagues/${s}/reserve7s/standings`,className:`lad-comp-btn`,children:`7s`})]}),h.length===0?(0,o.jsxs)(`div`,{className:`lad-empty`,children:[(0,o.jsx)(`i`,{className:`bi bi-bar-chart`}),(0,o.jsx)(`h4`,{children:`No teams yet`}),(0,o.jsx)(`p`,{children:`Teams will appear here once they join the league.`})]}):(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(`div`,{className:`lad-head`,children:[(0,o.jsx)(`span`,{children:`#`}),(0,o.jsx)(`span`,{children:`Team`}),(0,o.jsx)(`span`,{children:`Status`}),(0,o.jsx)(`span`,{children:`W–L`}),(0,o.jsx)(`span`,{children:`Form · 5`}),(0,o.jsx)(`span`,{children:`Mov.`}),(0,o.jsx)(`span`,{children:_.for_label}),(0,o.jsx)(`span`,{children:_.pct_label}),(0,o.jsx)(`span`,{children:`Pts`})]}),(0,o.jsx)(`div`,{className:`lad-wrap`,children:h.map((e,n)=>{let r=n+1,i=w[e.team_id],a=y[String(e.team_id)],u=b[String(e.team_id)]||[],d=x!=null&&e.team_id===x,f=g>0&&r===g,p=c(e.team_id),m=i?.movement??0,h=a?.headline,_=l(h||``);return(0,o.jsxs)(`div`,{children:[(0,o.jsxs)(t,{to:`/leagues/${s}/team/${e.team_id}`,className:`lad-row${d?` mine`:``}`,style:{"--lad-accent":p.hex,"--lad-accent-rgb":p.rgb},children:[(0,o.jsx)(`span`,{className:`lad-rank${r<=3?` lad-rank-${r}`:``}`,children:r}),(0,o.jsx)(`span`,{className:`lad-team-name`,children:e.team?.name}),(0,o.jsx)(`span`,{className:`lad-status`,children:h?(0,o.jsx)(`span`,{className:`lad-pill lad-pill-${_}`,children:h}):(0,o.jsx)(`span`,{className:`lad-status-empty`,children:`—`})}),(0,o.jsxs)(`span`,{className:`lad-wl`,children:[(0,o.jsx)(`span`,{className:`w`,children:e.wins}),(0,o.jsx)(`span`,{className:`sep`,children:`–`}),(0,o.jsx)(`span`,{className:`l`,children:e.losses}),e.draws>0&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(`span`,{className:`sep`,children:`–`}),(0,o.jsx)(`span`,{className:`d`,children:e.draws})]})]}),(0,o.jsx)(`div`,{className:`lad-form`,children:(u.length>0?u:[,,,,,].fill(``)).slice(-5).map((e,t)=>(0,o.jsx)(`span`,{className:`lad-form-dot ${e}`,title:e||`No result`},t))}),(0,o.jsxs)(`span`,{className:`lad-momentum ${m>0?`up`:m<0?`down`:`flat`}`,children:[m>0&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(`i`,{className:`bi bi-caret-up-fill`,style:{fontSize:`.6rem`}}),m]}),m<0&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(`i`,{className:`bi bi-caret-down-fill`,style:{fontSize:`.6rem`}}),Math.abs(m)]}),m===0&&(0,o.jsx)(o.Fragment,{children:`—`})]}),(0,o.jsx)(`span`,{className:`lad-num`,children:e.points_for>0?Math.round(e.points_for):`–`}),(0,o.jsx)(`span`,{className:`lad-num`,children:e.percentage>0?(0,o.jsxs)(`span`,{style:e.percentage>=110?{color:`#6db38a`}:e.percentage<90?{color:`#d68a7e`}:void 0,children:[e.percentage.toFixed(1),(0,o.jsx)(`span`,{className:`unit`,children:`%`})]}):`–`}),(0,o.jsx)(`span`,{className:`lad-num lad-num-strong`,children:e.ladder_points})]}),f&&(0,o.jsx)(`div`,{className:`lad-cut`,children:(0,o.jsxs)(`span`,{children:[(0,o.jsx)(`i`,{className:`bi bi-trophy-fill`}),`Finals cut · top `,g]})},`cut-${e.team_id}`)]},e.team_id)})}),(0,o.jsxs)(`div`,{className:`lad-foot`,children:[(0,o.jsx)(`span`,{children:S&&v[0]?`Round ${v[0].afl_round} · Form, momentum & headlines updated weekly`:``}),(0,o.jsx)(`span`,{className:`scoring-tag`,"data-type":C,children:_.label})]})]})]})}export{f as t};