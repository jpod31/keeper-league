import{d as e,f as t,m as n,r,t as i,y as a}from"./jsx-runtime-mCRDCYrZ.js";import{t as o}from"./Spinner-BsfKBmVq.js";import{t as s}from"./useFetch-DfDfabMn.js";import{t as c}from"./LeagueSubnav-TCzO9ZjH.js";var l=a(n(),1),u=i(),d=`
...
`;function f(e){let t=e.toLowerCase();return t.includes(`supercoach`)?`sc`:t.includes(`fantasy`)?`af`:t.includes(`ultimate`)?`uf`:t.includes(`hybrid`)?`hybrid`:`custom`}function p({mode:n=`main`}={}){let{leagueId:i}=e(),[a]=t(),p=a.get(`round`),m=n===`sevens`,h=m?`/leagues/${i}/reserve7s/fixture`:`/leagues/${i}/fixture`,g=m?`/leagues/${i}/reserve7s/gameday`:`/leagues/${i}/gameday`,_=e=>m?`/leagues/${i}/reserve7s/matchup/${e}`:`/leagues/${i}/matchup/${e}`,{data:v,loading:y}=s(m?`/leagues/${i}/reserve7s/fixture?format=json${p?`&round=${p}`:``}`:`/leagues/${i}/fixture?format=json${p?`&round=${p}`:``}`),b=(0,l.useRef)(null);if((0,l.useEffect)(()=>{if(b.current){let e=b.current.querySelector(`.rnd-item.active`);if(e){let t=e.offsetLeft-b.current.offsetWidth/2+e.offsetWidth/2;b.current.scrollLeft=Math.max(0,t)}}},[v?.selected_round]),y)return(0,u.jsx)(o,{text:`Loading fixture...`});if(!v)return(0,u.jsx)(`p`,{className:`text-danger`,children:`Failed to load fixture`});let{round_meta:x,selected_round:S,current_fixtures:C,scoring:w,is_commissioner:T}=v,E=Object.keys(x).map(Number).sort((e,t)=>e-t),D=x[String(S)]||`scheduled`,O=f(w.label),k=E.length>0,A=m?`#bc8cff`:`#58a6ff`,j=m?`rgba(188,140,255,.08)`:`rgba(88,166,255,.08)`,M=m?`rgba(188,140,255,.3)`:`rgba(88,166,255,.3)`;return(0,u.jsxs)(`div`,{className:m?`fx-sevens`:``,children:[(0,u.jsx)(`style`,{children:d}),m&&(0,u.jsx)(`style`,{children:`
  ...
  `}),(0,u.jsx)(`div`,{className:`d-none d-lg-block`,children:(0,u.jsx)(c,{active:`fixture`,leagueId:i})}),(0,u.jsxs)(`div`,{className:`comp-toggle`,children:[m?(0,u.jsx)(r,{to:`/leagues/${i}/fixture`,className:`comp-toggle-btn text-decoration-none`,style:{borderColor:`#30363d`,color:`#8b949e`,borderRadius:`8px 0 0 8px`},children:`Main`}):(0,u.jsx)(`span`,{className:`comp-toggle-btn`,style:{borderColor:M,color:A,background:j,borderRadius:`8px 0 0 8px`},children:`Main`}),m?(0,u.jsx)(`span`,{className:`comp-toggle-btn`,style:{borderColor:M,color:A,background:j,borderRadius:`0 8px 8px 0`,borderLeft:0},children:`7s`}):(0,u.jsx)(r,{to:`/leagues/${i}/reserve7s/fixture`,className:`comp-toggle-btn text-decoration-none`,style:{borderColor:`#30363d`,color:`#8b949e`,borderRadius:`0 8px 8px 0`,borderLeft:0},children:`7s`})]}),k?(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`div`,{className:`rnd-strip`,ref:b,children:E.map(e=>{let t=x[String(e)],n=t===`completed`?`rnd-dot-done`:t===`live`?`rnd-dot-live`:t===`partial`?`rnd-dot-part`:`rnd-dot-none`,i=t===`completed`?` rnd-done`:t===`live`?` rnd-live`:``;return(0,u.jsxs)(r,{to:`${h}?round=${e}`,className:`rnd-item${e===S?` active`:``}${i}`,children:[(0,u.jsx)(`span`,{className:`rnd-num`,children:e===0?`PS`:e}),(0,u.jsx)(`span`,{className:`rnd-dot ${n}`})]},e)})}),(0,u.jsxs)(`div`,{className:`round-hdr`,children:[(0,u.jsxs)(`div`,{className:`round-hdr-left`,children:[(0,u.jsx)(`h3`,{children:S===0?`Pre-Season`:`Round ${S}`}),D===`completed`&&(0,u.jsx)(`span`,{className:`rh-badge rh-complete`,children:`Complete`}),D===`live`&&(0,u.jsxs)(`span`,{className:`rh-badge rh-live`,children:[(0,u.jsx)(`i`,{className:`bi bi-broadcast me-1`,style:{fontSize:`.5rem`}}),`Live`]}),D===`partial`&&(0,u.jsx)(`span`,{className:`rh-badge rh-progress`,children:`In Progress`}),(0,u.jsx)(`span`,{className:`scoring-tag`,"data-type":O,children:w.label})]}),(0,u.jsx)(`div`,{className:`rh-actions`,children:C.length>0&&(D===`live`||D===`completed`||D===`partial`)&&(0,u.jsxs)(r,{to:`${g}?round=${S}`,className:`rh-btn`,children:[(0,u.jsx)(`i`,{className:`bi bi-broadcast me-1`}),`Live`]})})]}),(0,u.jsx)(`div`,{className:`mx-list`,children:C.map(e=>{let t=e.status===`completed`&&(e.home_score||0)>(e.away_score||0),n=e.status===`completed`&&(e.away_score||0)>(e.home_score||0),i=D===`live`||D===`partial`?`${g}?round=${S}&fixture=${e.id}`:_(e.id),a=e.status===`live`||e.status===`partial`,o=a&&(e.home_score||0)>(e.away_score||0),s=a&&(e.away_score||0)>(e.home_score||0),c=e.status===`completed`||a||e.home_score!=null&&e.away_score!=null,l=a&&!!e.home_total&&!!e.away_total,d=e.home_total?`${e.home_played??0}/${e.home_total}`:null,f=e.away_total?`${e.away_played??0}/${e.away_total}`:null,p={display:`block`,maxWidth:`100%`,whiteSpace:`nowrap`,overflow:`hidden`,textOverflow:`ellipsis`};return(0,u.jsxs)(r,{to:i,className:`mx-row`,style:{position:`relative`},children:[(0,u.jsxs)(`div`,{className:`mx-team mx-team-home`,style:{display:`flex`,flexDirection:`column`,alignItems:`flex-start`,gap:1,minWidth:0},children:[(0,u.jsx)(`span`,{className:t||o?`won`:``,style:{...p,fontWeight:t||o?700:500},children:e.home_team?.name}),l&&d&&(0,u.jsxs)(`span`,{style:{fontSize:`.62rem`,color:`#6e7681`,fontVariantNumeric:`tabular-nums`,fontWeight:500},children:[d,` played`]})]}),(0,u.jsx)(`div`,{className:`mx-centre`,style:{minWidth:90},children:c?(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`span`,{className:`mx-sc${t||o?` won`:n||s?` lost`:` draw`}`,children:Math.round(e.home_score||0)}),(0,u.jsx)(`span`,{className:`mx-sep`,children:`–`}),(0,u.jsx)(`span`,{className:`mx-sc${n||s?` won`:t||o?` lost`:` draw`}`,children:Math.round(e.away_score||0)})]}):(0,u.jsx)(`span`,{className:`mx-vs`,children:`vs`})}),(0,u.jsxs)(`div`,{className:`mx-team mx-team-away`,style:{display:`flex`,flexDirection:`column`,alignItems:`flex-end`,gap:1,minWidth:0},children:[(0,u.jsx)(`span`,{className:n||s?`won`:``,style:{...p,fontWeight:n||s?700:500,textAlign:`right`},children:e.away_team?.name}),l&&f&&(0,u.jsxs)(`span`,{style:{fontSize:`.62rem`,color:`#6e7681`,fontVariantNumeric:`tabular-nums`,fontWeight:500},children:[f,` played`]})]}),(0,u.jsx)(`div`,{className:`mx-arrow`,children:(0,u.jsx)(`i`,{className:`bi bi-chevron-right`,style:{fontSize:`.65rem`}})})]},e.id)})})]}):(0,u.jsxs)(`div`,{className:`season-empty`,children:[(0,u.jsx)(`i`,{className:`bi bi-calendar-week`}),(0,u.jsx)(`h4`,{children:`No fixture generated`}),(0,u.jsx)(`p`,{children:T?(0,u.jsxs)(u.Fragment,{children:[`Head to `,(0,u.jsx)(r,{to:`/leagues/${i}/settings`,children:`Settings`}),` to generate the season fixture.`]}):`The commissioner hasn't set up the fixture yet.`})]})]})}export{p as t};