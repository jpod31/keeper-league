...
`;function m(){let{leagueId:n}=e(),[i]=t(),a=i.get(`fixture`),f=i.get(`round`),[m,ne]=(0,l.useState)(null),[re,ie]=(0,l.useState)(!0),[h,g]=(0,l.useState)(a?Number(a):null),[_,ae]=(0,l.useState)({}),[v,y]=(0,l.useState)(!1),[oe,b]=(0,l.useState)(!1),x=(0,l.useRef)({left:0,right:0}),S=(0,l.useCallback)(()=>{o(`/leagues/${n}/gameday?format=json${f?`&round=${f}`:``}`).then(e=>{ne(e),!h&&e.fixture&&g(e.fixture.id)}).catch(()=>{}).finally(()=>ie(!1))},[n,f]),se=(0,l.useCallback)(()=>{m&&o(`/leagues/${n}/gameday/api/fixtures?round=${m.afl_round}`).then(e=>{let t={};e.fixtures?.forEach(e=>{t[e.fixture_id]=e}),ae(t)}).catch(()=>{})},[n,m?.afl_round]);(0,l.useEffect)(()=>{S();let e=setInterval(S,6e4);return()=>clearInterval(e)},[S]),(0,l.useEffect)(()=>{a&&g(Number(a))},[a]),(0,l.useEffect)(()=>{m?.gameday_state},[m?.gameday_state]);let ce=(0,l.useRef)(null),C=(0,l.useRef)(0),w=m?.gameday_state===`live`&&!!m?.live_enabled,T=m?.afl_round;(0,l.useEffect)(()=>{if(!w)return;let e=c(`/matchups`,{withCredentials:!0,reconnection:!0,reconnectionAttempts:1/0,reconnectionDelay:2e3,reconnectionDelayMax:3e4});return ce.current=e,e.on(`connect`,()=>{e.emit(`join_live`,{league_id:Number(n),afl_round:T}),e.emit(`request_scores`,{league_id:Number(n),afl_round:T})}),e.on(`score_update`,e=>{e.seq&&e.seq<=C.current||(e.seq&&(C.current=e.seq),e.fixtures&&ae(t=>{let n={...t};return e.fixtures.forEach(e=>{n[e.fixture_id]=e}),n}))}),()=>{e.disconnect(),ce.current=null}},[n,w,T]);let E=(0,l.useRef)(!1);(0,l.useEffect)(()=>{m&&!E.current&&(E.current=!0,se())},[m,se]);let D=(0,l.useCallback)(e=>{g(e)},[]),le=(0,l.useCallback)(async()=>{y(!0);try{await o(`/leagues/${n}/gameday/sync-scores`,{method:`POST`}).catch(()=>{}),S()}finally{setTimeout(()=>y(!1),1e3)}},[n,S]);if((0,l.useEffect)(()=>{if(m?.gameday_state!==`upcoming`)return;let e=setInterval(()=>{o(`/leagues/${n}/gameday/api/fixtures?round=${m.afl_round}`).then(e=>{}).catch(()=>{})},3e5);return()=>clearInterval(e)},[m?.gameday_state,m?.afl_round,n]),re)return(0,u.jsx)(d,{});if(!m)return(0,u.jsx)(`p`,{className:`text-danger`,children:`Failed to load gameday`});let O=new Set(m.teams_playing||[]);function k(e){let t=new Set([`field`,`reserve`]),n=e.filter(e=>t.has(e.lineup_type)&&(O.size===0||O.has(e.afl_team)));return{played:n.filter(e=>e.game_started&&((e.score||0)>0||e.is_dnp)).length,total:n.length}}function ue(e){let t=!1,n=!1,r=!1,i=!1;return e.forEach(e=>{let a=e.game_started&&((e.score||0)>0||e.is_dnp);e.is_captain&&(t=!0,n=a),e.is_vice_captain&&(r=!0,i=a)}),{hasCap:t,capPlayed:n,hasVc:r,vcPlayed:i}}function A({players:e,rs:t}){let n=t&&t.has_captain!==void 0?{hasCap:!!t.has_captain,capPlayed:!!t.captain_played,hasVc:!!t.has_vc,vcPlayed:!!t.vc_played}:ue(e);return(0,u.jsxs)(`span`,{style:{display:`inline-flex`,gap:4},children:[n.hasCap&&(0,u.jsx)(`span`,{className:`gd-role-badge${n.capPlayed?` active`:``}`,children:`C`}),n.hasVc&&(0,u.jsx)(`span`,{className:`gd-role-badge vc${n.vcPlayed?` active`:``}`,children:`VC`})]})}let j=m,M=j.gameday_state,N=!h||h===j.fixture?.id,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J=null,Y=null,X=null,Z=null;if(N||!_[h])P=j.my_team?.name||``,F=j.opp_team?.name||``,I=j.my_score,L=j.opp_score,R=j.my_captain_bonus,z=j.opp_captain_bonus,B=j.my_players||[],V=j.opp_players||[],H=j.my_team?.logo_url,U=j.opp_team?.logo_url,K=j.my_team?.id,q=j.opp_team?.id,N&&j.projections&&(J=j.projections.my_projected,Y=j.projections.opp_projected,X=j.projections.my_win_pct,Z=j.projections.opp_win_pct);else{let e=_[h],t=j.round_fixtures.find(e=>e.id===h);P=t?.home_team?.name||``,F=t?.away_team?.name||``,I=e.home_score||0,L=e.away_score||0,R=e.home_captain_bonus||0,z=e.away_captain_bonus||0,B=e.home_players||[],V=e.away_players||[],H=t?.home_team?.logo_url,U=t?.away_team?.logo_url,K=t?.home_team_id,q=t?.away_team_id,e.projections&&(J=e.projections.home_projected,Y=e.projections.away_projected,X=e.projections.home_win_pct,Z=e.projections.away_win_pct)}K!=null&&(W=j.round_scores?.[String(K)]),q!=null&&(G=j.round_scores?.[String(q)]);let Q=Math.abs(Math.round(I-L));if(I!==x.current.left||L!==x.current.right){if((x.current.left!==0||x.current.right!==0)&&(setTimeout(()=>{b(!0),setTimeout(()=>b(!1),1500)},0),typeof navigator<`u`&&navigator.vibrate))try{navigator.vibrate(12)}catch{}x.current={left:I,right:L}}function $({p:e}){let t=!e.game_started&&M===`live`,n=e.subbed_on,r=e.is_emergency&&!n,i=[`gd-prow`,!!(e.player_id&&j.locked_player_ids?.includes(e.player_id))&&`locked`,e.is_dnp&&`dnp`,n&&`subbed-on`,e.lineup_type===`reserve`&&`reserve`,r&&`emg-standby`,t&&`ytp`].filter(Boolean).join(` `),a=[`gd-pscore`,e.is_dnp&&`dnp`,(e.lineup_type===`reserve`||r)&&`muted`,t&&`ytp`,e.is_live&&!t&&!r&&`live`].filter(Boolean).join(` `),o=(e.position||``).split(`/`)[0].toUpperCase();return(0,u.jsxs)(`div`,{className:i,children:[(0,u.jsx)(`span`,{className:`gd-pos ${o.toLowerCase()}`,children:o||`—`}),(0,u.jsxs)(`div`,{className:`gd-pbody`,children:[(0,u.jsxs)(`div`,{className:`gd-prow-name`,children:[e.is_captain&&(0,u.jsx)(`span`,{className:`gd-pbadge c`,children:`C`}),e.is_vice_captain&&(0,u.jsx)(`span`,{className:`gd-pbadge vc`,children:`VC`}),n&&(0,u.jsx)(`span`,{className:`gd-pbadge emg-active`,children:`EMG`}),e.is_dnp&&!n&&(0,u.jsx)(`span`,{className:`gd-pbadge dnp`,children:`DNP`}),r&&(0,u.jsx)(`span`,{className:`gd-pbadge emg`,children:`EMG`}),(0,u.jsx)(`span`,{className:`gd-pname`,children:e.name})]}),(0,u.jsxs)(`div`,{className:`gd-pfix`,children:[e.afl_team&&j.team_logos[e.afl_team]?(0,u.jsx)(`img`,{src:j.team_logos[e.afl_team],alt:e.afl_team,title:e.afl_team}):(0,u.jsx)(`span`,{children:e.afl_team}),j.afl_matchup_info[e.afl_team]&&(0,u.jsx)(`span`,{children:j.afl_matchup_info[e.afl_team]}),e.replaces&&(0,u.jsxs)(`span`,{className:`gd-sub-note`,children:[`→ for `,e.replaces]})]})]}),(0,u.jsx)(`span`,{className:a,children:e.lineup_type===`reserve`||r?`–`:t?(0,u.jsx)(u.Fragment,{children:(0,u.jsx)(`i`,{className:`bi bi-clock`,style:{fontSize:`.62rem`}})}):e.score||0})]})}function de({players:e,teamName:t,score:n}){let r=e=>O.size===0||O.has(e.afl_team),i=e.filter(e=>e.lineup_type===`field`&&!e.is_dnp&&r(e)),a=e.filter(e=>e.lineup_type===`emergency`&&e.subbed_on&&r(e)),o=[...i,...a],s=e.filter(e=>e.lineup_type===`reserve`&&r(e)),c=e.filter(e=>e.lineup_type===`emergency`&&!e.subbed_on&&r(e)),l=e.filter(e=>e.is_dnp&&r(e)),d=e.filter(e=>!r(e));return(0,u.jsxs)(`div`,{className:`gd-pcard`,children:[(0,u.jsxs)(`div`,{className:`gd-pcard-header`,children:[(0,u.jsx)(`span`,{className:`gd-pcard-name`,children:t}),M!==`upcoming`&&(0,u.jsx)(`span`,{className:`gd-pcard-total`,children:Math.round(n)})]}),(0,u.jsxs)(`div`,{children:[(0,u.jsxs)(`div`,{className:`gd-section field`,children:[(0,u.jsx)(`i`,{className:`bi bi-broadcast`}),`Field · `,o.length]}),o.map((e,t)=>(0,u.jsx)($,{p:e},t)),s.length>0&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsxs)(`div`,{className:`gd-section bench`,children:[(0,u.jsx)(`i`,{className:`bi bi-arrow-left-right`}),`Bench · `,s.length]}),s.map((e,t)=>(0,u.jsx)($,{p:e},`b${t}`))]}),c.length>0&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsxs)(`div`,{className:`gd-section emergency`,children:[(0,u.jsx)(`i`,{className:`bi bi-shield-exclamation`}),`Emergency · `,c.length]}),c.map((e,t)=>(0,u.jsx)($,{p:e},`e${t}`))]}),l.length>0&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsxs)(`div`,{className:`gd-section dnp`,children:[(0,u.jsx)(`i`,{className:`bi bi-x-circle`}),`Did Not Play · `,l.length]}),l.map((e,t)=>(0,u.jsx)($,{p:e},`d${t}`))]}),d.length>0&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsxs)(`div`,{className:`gd-section nogame`,children:[(0,u.jsx)(`i`,{className:`bi bi-calendar-x`}),`No Game · `,d.length]}),d.map((e,t)=>(0,u.jsx)($,{p:e},`ng${t}`))]})]})]})}return(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`style`,{children:p}),(0,u.jsxs)(`div`,{className:`gd-comp-toggle`,children:[(0,u.jsx)(`span`,{className:`gd-comp-btn active`,children:`Main`}),(0,u.jsx)(r,{to:`/leagues/${n}/reserve7s/gameday`,className:`gd-comp-btn`,children:`7s`})]}),(0,u.jsxs)(`div`,{className:`gd-round-bar`,children:[(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`div`,{className:`gd-round-title`,children:j.afl_round===0?`PRE-SEASON`:`ROUND ${j.afl_round}`}),j.round_dates&&(0,u.jsx)(`div`,{className:`gd-round-dates`,children:j.round_dates})]}),(0,u.jsxs)(`div`,{className:`gd-round-state`,children:[(()=>{let e=te(j);return(0,u.jsxs)(`div`,{className:`gd-clock ${e.tone}`,children:[(0,u.jsx)(`span`,{className:`gd-clock-label`,children:e.label}),(0,u.jsx)(`span`,{className:`gd-clock-sub`,children:e.sub})]})})(),(0,u.jsx)(`button`,{className:`gd-refresh`,onClick:le,disabled:v,title:`Sync scores`,children:v?(0,u.jsx)(`span`,{className:`spinner-border spinner-border-sm`,style:{width:12,height:12}}):(0,u.jsx)(`i`,{className:`bi bi-arrow-clockwise`})})]})]}),j.afl_games&&j.afl_games.length>0&&(()=>{let e=e=>e===`live`?0:e===`complete`?2:1;return(0,u.jsx)(`div`,{className:`gd-ticker d-none d-lg-flex`,children:[...j.afl_games].sort((t,n)=>e(t.status)-e(n.status)).map(e=>{let t=e.status===`live`?`live`:e.status===`complete`?`done`:`upcoming`,i=j.team_abbr[e.home_team]||e.home_team.substring(0,3).toUpperCase(),a=j.team_abbr[e.away_team]||e.away_team.substring(0,3).toUpperCase();return(0,u.jsxs)(r,{to:`/leagues/${n}/gameday/afl-game/${e.game_id}`,className:`gd-ticker-pill ${t}`,children:[(0,u.jsx)(`span`,{className:`gd-ticker-dot`}),(0,u.jsxs)(`span`,{className:`gd-ticker-teams`,children:[i,` v `,a]}),e.home_score!=null&&(0,u.jsxs)(`span`,{className:`gd-ticker-score`,children:[e.home_score,`-`,e.away_score]}),(0,u.jsx)(`span`,{className:`gd-ticker-tag`,children:e.status===`live`?`LIVE`:e.status===`complete`?`FT`:e.scheduled_display||(e.scheduled_start?e.scheduled_start.substring(11,16):`TBC`)})]},e.game_id)})})})(),j.round_fixtures&&j.round_fixtures.length>0&&(0,u.jsx)(`div`,{className:`gd-mini-bar`,children:j.round_fixtures.map(e=>{let t=_[e.id],n=t?.home_score??j.round_scores[String(e.home_team_id)]?.total_score??0,r=t?.away_score??j.round_scores[String(e.away_team_id)]?.total_score??0,i=!!(j.my_team&&(e.home_team_id===j.my_team.id||e.away_team_id===j.my_team.id)),a=h===e.id;return(0,u.jsxs)(`div`,{className:[`gd-mini-pill`,a&&`active`,i&&!a&&`yours`].filter(Boolean).join(` `),onClick:()=>D(e.id),children:[(0,u.jsxs)(`span`,{className:`gd-mini-teams`,children:[e.home_team?.name,` v `,e.away_team?.name]}),e.status!==`scheduled`&&(0,u.jsxs)(`span`,{className:`gd-mini-score`,children:[Math.round(n),`-`,Math.round(r)]})]},e.id)})}),j.is_bye?(0,u.jsxs)(`div`,{className:`gd-bye`,children:[(0,u.jsxs)(`h4`,{children:[(0,u.jsx)(`i`,{className:`bi bi-dash-circle me-2`}),`Bye this round`]}),(0,u.jsx)(`p`,{children:`Click any matchup above to view it.`})]}):(0,u.jsxs)(u.Fragment,{children:[(()=>{let e=ee(K),t=ee(q),i=I>L,a=L>I,o=M===`upcoming`,c=W?.players_total==null?k(B):{played:W.players_played??0,total:W.players_total},l=G?.players_total==null?k(V):{played:G.players_played??0,total:G.players_total},d={"--gd-side-accent":`rgba(${e.rgb},.6)`,"--gd-side-hex":e.hex,"--gd-side-rgb":e.rgb},f={"--gd-side-accent":`rgba(${t.rgb},.6)`,"--gd-side-hex":t.hex,"--gd-side-rgb":t.rgb},te={"--gd-left-accent":e.hex,"--gd-right-accent":t.hex},p=`gd-hero-score${o?` pre`:i?` leading`:``}${oe?` score-flash`:``}`,m=`gd-hero-score${o?` pre`:a?` leading`:``}${oe?` score-flash`:``}`;return(0,u.jsxs)(`div`,{className:`gd-hero`,children:[(0,u.jsxs)(`div`,{className:`gd-hero-band`,style:te,children:[(0,u.jsx)(`span`,{className:`gd-hero-band-l`}),(0,u.jsx)(`span`,{className:`gd-hero-band-r`})]}),(0,u.jsxs)(`div`,{className:`gd-hero-split`,children:[(0,u.jsxs)(`div`,{className:`gd-hero-side`,style:d,children:[N&&(0,u.jsx)(`span`,{className:`gd-hero-you`,children:`YOU`}),(0,u.jsxs)(`div`,{className:`gd-hero-top`,children:[(0,u.jsx)(`span`,{className:`gd-hero-crest`,children:H?(0,u.jsx)(`img`,{src:H,alt:``}):P.substring(0,2).toUpperCase()}),(0,u.jsx)(`span`,{className:`gd-hero-name`,children:P})]}),(0,u.jsx)(`div`,{className:`gd-hero-score-wrap`,children:(0,u.jsx)(s,{value:I,className:p})}),(0,u.jsxs)(`div`,{className:`gd-hero-meta`,children:[c.total>0&&(0,u.jsxs)(`span`,{className:`gd-hero-played`,children:[c.played,`/`,c.total,` played`]}),(0,u.jsx)(A,{players:B,rs:W}),R>0&&(0,u.jsxs)(`span`,{className:`gd-cap-bonus`,children:[`+`,Math.round(R),` C`]})]})]}),(0,u.jsxs)(`div`,{className:`gd-hero-side right`,style:f,children:[(0,u.jsxs)(`div`,{className:`gd-hero-top`,children:[(0,u.jsx)(`span`,{className:`gd-hero-crest`,children:U?(0,u.jsx)(`img`,{src:U,alt:``}):F.substring(0,2).toUpperCase()}),(0,u.jsx)(`span`,{className:`gd-hero-name`,children:F})]}),(0,u.jsx)(`div`,{className:`gd-hero-score-wrap`,children:(0,u.jsx)(s,{value:L,className:m})}),(0,u.jsxs)(`div`,{className:`gd-hero-meta`,children:[z>0&&(0,u.jsxs)(`span`,{className:`gd-cap-bonus`,children:[`+`,Math.round(z),` C`]}),(0,u.jsx)(A,{players:V,rs:G}),l.total>0&&(0,u.jsxs)(`span`,{className:`gd-hero-played`,children:[l.played,`/`,l.total,` played`]})]})]})]}),(0,u.jsx)(`div`,{className:`gd-hero-strip`,children:M===`upcoming`?(0,u.jsxs)(u.Fragment,{children:[j.first_bounce&&(0,u.jsxs)(`span`,{className:`gd-first-bounce`,children:[(0,u.jsx)(`i`,{className:`bi bi-clock-fill`}),`First bounce `,j.first_bounce]}),J!=null&&Y!=null&&(0,u.jsxs)(`div`,{className:`gd-proj-row`,children:[(0,u.jsxs)(`span`,{className:`gd-proj-item`,children:[`Proj `,(0,u.jsx)(`b`,{children:Math.round(J)}),`–`,(0,u.jsx)(`b`,{children:Math.round(Y)})]}),(0,u.jsx)(`span`,{className:`gd-proj-sep`}),(0,u.jsxs)(`span`,{className:`gd-proj-item`,children:[`Win `,(0,u.jsxs)(`b`,{children:[Math.round(X||0),`%`]}),`–`,(0,u.jsxs)(`b`,{children:[Math.round(Z||0),`%`]})]})]})]}):M===`completed`?(0,u.jsxs)(u.Fragment,{children:[(i||a)&&(0,u.jsx)(`div`,{className:`gd-margin-chip${N&&i?` win`:N&&a?` loss`:``}`,children:N?i?(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`i`,{className:`bi bi-trophy-fill`}),`WON BY `,Q]}):(0,u.jsxs)(u.Fragment,{children:[`LOST BY `,Q]}):i?(0,u.jsxs)(u.Fragment,{children:[P,` BY `,Q]}):(0,u.jsxs)(u.Fragment,{children:[F,` BY `,Q]})}),!i&&!a&&(0,u.jsx)(`div`,{className:`gd-margin-chip`,children:`DRAW`}),j.fixture&&(0,u.jsxs)(r,{to:`/leagues/${n}/matchup/${j.fixture.id}`,className:`gd-breakdown-link`,children:[(0,u.jsx)(`i`,{className:`bi bi-bar-chart-line`}),`Full Breakdown`]})]}):(0,u.jsxs)(u.Fragment,{children:[(i||a)&&(0,u.jsx)(`div`,{className:`gd-margin-chip${N&&i?` up`:N&&a?` down`:``}`,children:N?i?(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`i`,{className:`bi bi-caret-up-fill`}),`UP `,Q]}):(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`i`,{className:`bi bi-caret-down-fill`}),`DOWN `,Q]}):i?(0,u.jsxs)(u.Fragment,{children:[P,` BY `,Q]}):(0,u.jsxs)(u.Fragment,{children:[F,` BY `,Q]})}),J!=null&&Y!=null&&(0,u.jsxs)(`div`,{className:`gd-proj-row`,children:[(0,u.jsxs)(`span`,{className:`gd-proj-item`,children:[`Proj `,(0,u.jsx)(`b`,{children:Math.round(J)}),`–`,(0,u.jsx)(`b`,{children:Math.round(Y)})]}),(0,u.jsx)(`span`,{className:`gd-proj-sep`}),(0,u.jsxs)(`span`,{className:`gd-proj-item`,children:[`Win `,(0,u.jsxs)(`b`,{children:[Math.round(X||0),`%`]}),`–`,(0,u.jsxs)(`b`,{children:[Math.round(Z||0),`%`]})]})]})]})})]})})(),(0,u.jsxs)(`div`,{className:`d-lg-none mt-3 gd-mob-vs`,children:[(0,u.jsxs)(`div`,{className:`gd-mob-vs-header`,children:[(0,u.jsx)(`span`,{className:`gd-mob-vs-team`,children:P}),(0,u.jsxs)(`span`,{className:`gd-mob-vs-scores`,children:[(0,u.jsx)(`span`,{className:`gd-mob-vs-sc${I>L?` gd-mob-sc-win`:``}`,children:Math.round(I)}),(0,u.jsx)(`span`,{style:{color:`#484f58`,fontSize:`.7rem`},children:`v`}),(0,u.jsx)(`span`,{className:`gd-mob-vs-sc${L>I?` gd-mob-sc-win`:``}`,children:Math.round(L)})]}),(0,u.jsx)(`span`,{className:`gd-mob-vs-team`,style:{textAlign:`right`},children:F})]}),(0,u.jsxs)(`div`,{className:`gd-mob-section-hdr`,children:[(0,u.jsx)(`i`,{className:`bi bi-people-fill me-1`}),`Field`]}),(()=>{let e=e=>[...e.filter(e=>e.lineup_type===`field`&&!e.is_dnp),...e.filter(e=>e.lineup_type===`emergency`&&e.subbed_on)],t=e(B),n=e(V),r=Math.max(t.length,n.length);return Array.from({length:r}).map((e,r)=>{let i=t[r],a=n[r];return(0,u.jsxs)(`div`,{className:`gd-mob-vs-row`,children:[(0,u.jsx)(`div`,{className:`gd-mob-vs-left`,children:i&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsxs)(`span`,{className:`gd-mob-vs-name`,children:[i.is_captain&&(0,u.jsx)(`b`,{className:`gd-mob-c`,children:`C`}),i.is_vice_captain&&(0,u.jsx)(`b`,{className:`gd-mob-vc`,children:`VC`}),i.subbed_on&&(0,u.jsx)(`span`,{className:`gameday-badge-emg-active`,style:{fontSize:`.5rem`,padding:`0 3px`},children:`EMG`}),i.name]}),(0,u.jsx)(`span`,{className:`gd-mob-vs-pos pos-badge pos-${(i.position||`MID`).split(`/`)[0].toUpperCase()}`,children:(i.position||`MID`).split(`/`)[0].substring(0,3).toUpperCase()})]})}),(0,u.jsxs)(`div`,{className:`gd-mob-vs-mid`,children:[(0,u.jsxs)(`span`,{className:`gd-mob-sc-l${i?.is_live?` text-success`:``}`,children:[i?i.score||0:`-`,i?.is_live&&(0,u.jsx)(`i`,{className:`bi bi-circle-fill gameday-live-dot`})]}),(0,u.jsxs)(`span`,{className:`gd-mob-sc-r${a?.is_live?` text-success`:``}`,children:[a?a.score||0:`-`,a?.is_live&&(0,u.jsx)(`i`,{className:`bi bi-circle-fill gameday-live-dot`})]})]}),(0,u.jsx)(`div`,{className:`gd-mob-vs-right`,children:a&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`span`,{className:`gd-mob-vs-pos pos-badge pos-${(a.position||`MID`).split(`/`)[0].toUpperCase()}`,children:(a.position||`MID`).split(`/`)[0].substring(0,3).toUpperCase()}),(0,u.jsxs)(`span`,{className:`gd-mob-vs-name`,children:[a.is_captain&&(0,u.jsx)(`b`,{className:`gd-mob-c`,children:`C`}),a.is_vice_captain&&(0,u.jsx)(`b`,{className:`gd-mob-vc`,children:`VC`}),a.subbed_on&&(0,u.jsx)(`span`,{className:`gameday-badge-emg-active`,style:{fontSize:`.5rem`,padding:`0 3px`},children:`EMG`}),a.name]})]})})]},r)})})()]}),(0,u.jsxs)(`div`,{className:`row g-3 mt-2 d-none d-lg-flex`,children:[(0,u.jsx)(`div`,{className:`col-md-6`,children:(0,u.jsx)(de,{players:B,teamName:P,score:I})}),(0,u.jsx)(`div`,{className:`col-md-6`,children:(0,u.jsx)(de,{players:V,teamName:F,score:L})})]})]}),(0,u.jsxs)(`div`,{className:`gd-foot`,children:[(0,u.jsx)(`span`,{children:M===`live`?(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`i`,{className:`bi bi-broadcast me-1`,style:{color:`#7dc99a`}}),`Live · WebSocket sync`]}):M===`completed`?`Final results`:(0,u.jsx)(u.Fragment,{children:`\xA0`})}),(0,u.jsx)(r,{to:`/leagues/${n}/fixture`,children:`Season Fixture →`})]}),(0,u.jsxs)(`div`,{className:`gameday-all-matchups mt-4`,style:{display:`none`},children:[(0,u.jsxs)(`div`,{className:`gameday-matchups-header`,children:[(0,u.jsxs)(`span`,{children:[(0,u.jsx)(`i`,{className:`bi bi-grid-3x2-gap me-2`}),`ROUND `,j.afl_round,` MATCHUPS`]}),j.round_dates&&(0,u.jsx)(`span`,{className:`matchups-header-dates`,children:j.round_dates})]}),(0,u.jsx)(`div`,{className:`gameday-matchups-grid`,children:(j.round_fixtures||[]).map(e=>{let t=j.round_scores[String(e.home_team_id)]?.total_score||e.home_score||0,n=j.round_scores[String(e.away_team_id)]?.total_score||e.away_score||0,r=j.my_team&&(e.home_team_id===j.my_team.id||e.away_team_id===j.my_team.id),i=t>n&&e.status!==`scheduled`,a=n>t&&e.status!==`scheduled`,o=t+n||1;return(0,u.jsxs)(`div`,{className:`gameday-matchup-card${r?` matchup-yours`:``}${h===e.id?` matchup-active`:``}${r&&h!==e.id?` matchup-yours-dimmed`:``}`,onClick:()=>D(e.id),style:{cursor:`pointer`},children:[r&&(0,u.jsx)(`span`,{className:`matchup-your-tag`,children:`Your Match`}),(0,u.jsxs)(`div`,{className:`matchup-team-row`,children:[(0,u.jsx)(`span`,{className:`matchup-team-name${i?` matchup-winner`:``}`,children:e.home_team?.name}),(0,u.jsxs)(`span`,{className:`matchup-team-score`,children:[e.status!==`scheduled`&&Math.round(t),i&&(0,u.jsx)(`i`,{className:`bi bi-check-lg`,style:{color:`var(--kl-accent-green)`,fontSize:`.7rem`}})]})]}),(0,u.jsxs)(`div`,{className:`matchup-team-row`,children:[(0,u.jsx)(`span`,{className:`matchup-team-name${a?` matchup-winner`:``}`,children:e.away_team?.name}),(0,u.jsxs)(`span`,{className:`matchup-team-score`,children:[e.status!==`scheduled`&&Math.round(n),a&&(0,u.jsx)(`i`,{className:`bi bi-check-lg`,style:{color:`var(--kl-accent-green)`,fontSize:`.7rem`}})]})]}),e.status!==`scheduled`&&(0,u.jsx)(`div`,{className:`matchup-mini-bar`,children:(0,u.jsx)(`div`,{className:`matchup-mini-fill`,style:{width:`${t/o*100}%`}})}),_[e.id]&&(0,u.jsxs)(`div`,{className:`d-flex justify-content-between align-items-center`,style:{marginTop:6},children:[(()=>{let t=k(_[e.id].home_players||[]);return t.total>0?(0,u.jsxs)(`span`,{className:`matchup-players-count`,style:{fontSize:`.6rem`,color:`var(--kl-text-faint)`},children:[t.played,`/`,t.total]}):(0,u.jsx)(`span`,{})})(),(0,u.jsxs)(`div`,{className:`d-flex gap-1`,children:[(0,u.jsx)(A,{players:_[e.id].home_players||[]}),(0,u.jsx)(A,{players:_[e.id].away_players||[]})]}),(()=>{let t=k(_[e.id].away_players||[]);return t.total>0?(0,u.jsxs)(`span`,{className:`matchup-players-count`,style:{fontSize:`.6rem`,color:`var(--kl-text-faint)`},children:[t.played,`/`,t.total]}):(0,u.jsx)(`span`,{})})()]}),e.status!==`scheduled`&&t!==n&&(0,u.jsxs)(`div`,{className:`matchup-margin`,children:[i?e.home_team?.name:e.away_team?.name,` +`,Math.round(Math.abs(t-n))]})]},e.id)})})]})]})}export{m as GamedayPage};